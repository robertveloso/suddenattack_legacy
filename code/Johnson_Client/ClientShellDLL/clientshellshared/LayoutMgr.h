...
// Edited By Bestline ==>
// Time : 2004-06-16 ¿ÀÈÄ 6:29:28
//  uint8		GetAmmoIconSize(int nLayout);
	LTIntPt		GetAmmoIconSize(int nLayout);
// Edited By Bestline <==
	...
	// ±¤½Ä
	LTIntPt		GetChatTexturePos(int nLayout);
...
//----------------------------------------------------------------------------------------
// [Bestline] 2004.04.21
    LTIntPt		GetArmorIconPos(int nLayout);
    LTIntPt		GetArmorIconSize(int nLayout);

	LTIntPt		GetGameHIHealthIconPos(int nLayout);
	LTIntPt		GetGameHIHealthIconSize(int nLayout);
	LTIntPt		GetGameHIBulletBarIconPos(int nLayout);
	LTIntPt		GetGameHIBulletBarIconSize(int nLayout);

	LTIntPt		GetTimePos(int nLayout);
	LTIntPt		GetTimeSize(int nLayout);
// [Bestline] 2004.04.21
//----------------------------------------------------------------------------------------
protected:

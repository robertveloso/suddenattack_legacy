...
public:
	...
	//[SPIKE]
	virtual VOID		  SetRandomFiringOn(LTBOOL bOn) {}
	virtual LTBOOL		  GetRandomFiringOn()  const { return 0;}
	virtual VOID		  SetZoomMode(uint8 nZoomMode) {}
	virtual uint8		  GetZoomMode()  const {return 0;}
	virtual VOID		  SetCurPostFireState(LTBOOL bPostFire){}
	virtual LTBOOL		  IsCurPostFireState() const {return 0;}
	...
	virtual uint8		GetNodeLastHit(){return 0;}
	virtual HOBJECT		GetObjectLastHit(){ return 0;}
};

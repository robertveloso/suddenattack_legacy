...
public:
	...
	IClientWeaponBase  *GetWeaponFromID( int32 nWeaponID ) const;
	...
	bool            ChangeWeapon( uint8 nWeaponId,
	                              ...
	                              int nAmmoAmount = -1,
								  bool bForceSetting = LTFALSE,
								  bool bForceLastSetting = LTFALSE,
	...
	//SPIKE
	int				GetCurrentWeaponNum() {return m_iCurrentWeapon;}
	IClientWeaponBase**	 GetApCurrentWeapon() {return m_apClientWeapon;}
	// ±¤½Ä
	// [05.02.11] 
	void			SetDeathAmmoInClip( uint8 nWeaponId, int nAmmoCount );
	void			ClearLastWeapon()	{ m_nLastWeaponId = WMGR_INVALID_ID; }
private:
	//
	// Private routines
	//		

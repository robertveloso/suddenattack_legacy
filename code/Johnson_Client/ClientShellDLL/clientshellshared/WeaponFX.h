...
class CWeaponFX : public CSpecialFX
{
	public :
		...
		void	CreateProjectileFX( HOBJECT hDamager, const LTVector& vFirePos, uint8 nAmmoID );
	...
	protected :
		...
		//[MURSUM]===================================================
		void    CreateBloodSplatFXFromProjectile( HOBJECT hDamager, const LTVector& vFirePos );
		void	CreateFlashBangFX( HOBJECT hDamager, const LTVector& vFirePos );
		//===========================================================
		
		//[SPIKE] ////////////////////////////
		void	CreatreProjectileMark();
		//////////////////////////////////////

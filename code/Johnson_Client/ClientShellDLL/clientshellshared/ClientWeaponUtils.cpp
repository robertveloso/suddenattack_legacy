...
void AddLocalImpactFX(uint8 nPlayerId, HLOCALOBJ hObj, const LTVector & vFirePos, const LTVector & vImpactPoint,
                      ...
                      uint8 nWeaponId, uint8 nAmmoId, uint16 wIgnoreFX)
{
    ...
    //w.bLocal        = LTTRUE;
	w.nShooterId    = nPlayerId;
    w.bLocal        = (nPlayerId == (uint8)dwId);

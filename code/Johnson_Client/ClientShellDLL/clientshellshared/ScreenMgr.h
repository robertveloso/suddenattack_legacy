...
public:
	...
	virtual void		HandleHotKey( unsigned char c );
	...
	//[MURSUM]
	eScreenID			GetPreviousScreenID();
	void				SetPreviousScreenID( eScreenID eID );

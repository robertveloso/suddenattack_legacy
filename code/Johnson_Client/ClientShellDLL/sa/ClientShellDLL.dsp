...
# PROP Scc_ProjName ""$/SA/Johnson_Code/Johnson_Client/ClientShellDLL/sa", JWSBAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe
...
# SUBTRACT LINK32 /map
# Begin Custom Build
TargetPath=\SA\Johnson_Code\Johnson_Client\Built\Release\ClientShellDll\SA\CShell.dll
InputPath=\SA\Johnson_Code\Johnson_Client\Built\Release\ClientShellDll\SA\CShell.dll
SOURCE="$(InputPath)"
...
# Begin Custom Build
TargetPath=\SA\Johnson_Code\Lib\Debug\CShell.dll
InputPath=\SA\Johnson_Code\Lib\Debug\CShell.dll
SOURCE="$(InputPath)"

"$(SA_MAIN_DIR)\game\CShell.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	Rem IncrediBuild_OutputFile $(TargetPath) 
...
# Begin Custom Build
TargetPath=\SA\Johnson_Code\Johnson_Client\Built\Final\ClientShellDll\SA\CShell.dll
InputPath=\SA\Johnson_Code\Johnson_Client\Built\Final\ClientShellDll\SA\CShell.dll
SOURCE="$(InputPath)"

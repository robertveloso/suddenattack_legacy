...
:	public					CPacket
{
	...
	void					Set( const char * i_strNick, const char * i_strChat )
	{
		...
		this->SetLength( sizeof( NN_Whisper ) - ( TYPE::s_nUserNick + 81 - 1 - i ) );
	}
...
private:
	...
	char					m_strBuff[ TYPE::s_nUserNick + 81 ];
};
...
:	public					CPacket
{
	...
	void					Optimize()
	{
		...
		this->SetLength( sizeof( SN_Info ) - ( nMaxSize - nCodeSize ) );
	}
};

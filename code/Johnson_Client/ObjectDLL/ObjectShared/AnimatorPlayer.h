...
class CAnimatorPlayer : public CAnimator
{
	...
	protected :
		...
		// 광식 : 달리기 8 방향으로 만들기
		//-----------------------------------------------------
		AniPlayerLowerStrafe		m_AniRunStrafeLeftF;
		AniPlayerLowerStrafe		m_AniRunStrafeLeftB;
		AniPlayerLowerStrafe		m_AniRunStrafeRightF;
		AniPlayerLowerStrafe		m_AniRunStrafeRightB;
		//-----------------------------------------------------
		...
		//[SPIKE] 앉아서 점프 추가 
		AniPlayerLower				m_AniCrouchJump_Jump;
		AniPlayerLower				m_AniCrouchJump_Tuck;
		AniPlayerLower				m_AniCrouchJump_Land;
		...
		AniPlayerUpper				m_AniRifleFire2;
		AniPlayerUpper				m_AniRifleFire3;
		...
		AniPlayerUpper				m_AniPistolFire2;
		AniPlayerUpper				m_AniPistolFire3;
		...
		AniPlayerUpper				m_AniMeleeAimEmpty;
		...
		AniPlayerUpper				m_AniThrowFirePre;
		AniPlayerUpper				m_AniThrowFire;
		AniPlayerUpper				m_AniThrowFire2;
		AniPlayerUpper				m_AniThrowFire3;
		AniPlayerUpper				m_AniThrowFirePos;
		...
		AniPlayerUpper				m_AniRifle2Fire2;
		AniPlayerUpper				m_AniRifle2Fire3;
		...
		AniPlayerUpper				m_AniRifle3Fire2;
		AniPlayerUpper				m_AniRifle3Fire3;
		AniPlayerUpper				m_AniRifle3Reload;
		AniPlayerUpper				m_AniRifle3PreReload;
		AniPlayerUpper				m_AniRifle3PostReload;
		...
		// eTimeBomb
		AniPlayerUpper				m_AniTimeBombUnalert;
		AniPlayerUpper				m_AniTimeBombAlert;
		AniPlayerUpper				m_AniTimeBombAim;
		AniPlayerUpper				m_AniTimeBombFirePre;
		AniPlayerUpper				m_AniTimeBombFire;
		AniPlayerUpper				m_AniTimeBombFire2;
		AniPlayerUpper				m_AniTimeBombFire3;
		AniPlayerUpper				m_AniTimeBombFirePos;
		AniPlayerUpper				m_AniTimeBombReload;
		AniPlayerUpper				m_AniTimeBombSelect;
		AniPlayerUpper				m_AniTimeBombDeselect;
		AniPlayerUpper				m_AniTimeBombAimLeanR;
		AniPlayerUpper				m_AniTimeBombAimLeanL;
		AniPlayerUpper				m_AniTimeBombFireLeanR;
		AniPlayerUpper				m_AniTimeBombFireLeanL;
		...
		AniPlayerUpper				m_AniHolsterFire2;
		AniPlayerUpper				m_AniHolsterFire3;
		...
		*/
		...
		AniPlayerUpper				m_AniPlaceFire2;
		AniPlayerUpper				m_AniPlaceFire3;
		...
		*/
		...
		AniPlayerUpper				m_AniGadgetFire2;
		AniPlayerUpper				m_AniGadgetFire3;
		...
		*/
		...
		AniPlayerUpper				m_AniStarsFire2;
		AniPlayerUpper				m_AniStarsFire3;

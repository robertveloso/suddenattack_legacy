...
class CWeapon
{
	public :
		...
		// ±¤½Ä
		//-----------------------------------------------------------------------
		void	SetAmmoInClip(int nAmmoInClip);
		//-----------------------------------------------------------------------
		...
		virtual WeaponState Fire(WeaponFireInfo & info, LTBOOL bForceDetonate = LTFALSE);
		virtual WeaponState HitPlayer(WeaponFireInfo & info, uint8 nHitCount);

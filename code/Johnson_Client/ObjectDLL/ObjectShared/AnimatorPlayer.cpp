...
#define AP_PLAYER_ANIM_DEBUG	0.0f
...
#define _N eAniInvalid
	...
	// 광식 : 이곳에서 4 방향 더 추가.
	//--------------------------------------------------------------------------------
	m_AniRunStrafeLeftF			= AniPlayerLowerStrafe		(LTTRUE,	 _A("LRLF"));
	m_AniRunStrafeLeftB			= AniPlayerLowerStrafe		(LTTRUE,	 _A("LRLB"));
	m_AniRunStrafeRightF		= AniPlayerLowerStrafe		(LTTRUE,	 _A("LRRF"));
	m_AniRunStrafeRightB		= AniPlayerLowerStrafe		(LTTRUE,	 _A("LRRB"));
	//--------------------------------------------------------------------------------
	...
	//[SPIKE] 앉은 상태에서 점프애니 
    m_AniCrouchJump_Jump        = AniPlayerLower            (LTFALSE,    _A("LCJJ"));
    m_AniCrouchJump_Tuck        = AniPlayerLower            (LTTRUE,     _A("LJT"));
    m_AniCrouchJump_Land        = AniPlayerLower            (LTFALSE,    _A("LCLJ"));
	...
	m_AniRifleUnalert           = AniPlayerUpper           (LTTRUE,     _A("URAm"), _A("URSAm"),    _A("URCAm"),    _A("URSwAm"),   _A("URCSAm"));
	...
	m_AniRifleFire2             = AniPlayerUpper           (LTFALSE,    _A("URFi"), _A("URSFi"),    _A("URCFi"),    _A("URSwFi"),   _A("URCSFi"));
	m_AniRifleFire3             = AniPlayerUpper           (LTFALSE,    _A("URFi"), _A("URSFi"),    _A("URCFi"),    _A("URSwFi"),   _A("URCSFi"));
	...
	m_AniPistolUnalert          = AniPlayerUpper           (LTTRUE,     _A("UPAm"), _A("UPSAm"),    _A("UPCAm"),    _N,             _A("UPCSAm"));    
	...
	m_AniPistolFire2            = AniPlayerUpper           (LTFALSE,    _A("UPFi"), _A("UPSFi"),    _A("UPCFi"),    _N,             _A("UPCSFi"));
    m_AniPistolFire3            = AniPlayerUpper           (LTFALSE,    _A("UPFi"), _A("UPSFi"),    _A("UPCFi"),    _N,             _A("UPCSFi"));
	...
	m_AniMeleeUnalert           = AniPlayerUpper           (LTTRUE,     _A("UMAm"), _A("UMSAm"),    _A("UMCAm"),    _N,             _A("UMCSAm"));
	...
	m_AniMeleeAimEmpty			= AniPlayerUpper           (LTTRUE,     _A("UMAmE"),_A("UMSAmE"),   _A("UMCAmE"),   _N,             _A("UMCSAmE"));
	...
	m_AniThrowUnalert           = AniPlayerUpper           (LTTRUE,     _A("UTAm"), _A("UTSAm"),    _A("UTCAm"),    _N,             _A("UTCSAm"));
	...
	// 추가
	//m_AniThrowFirePre			= AniPlayerUpper		   (LTFALSE,    _A("UTFPr"),_A("UTSFi"),    _A("UTCFi"),    _N,             _A("UTCSFi"));
	m_AniThrowFirePre			= AniPlayerUpper		   (LTFALSE,    _A("UTFPr"), _N,			_N,				_N,             _N);
    
	m_AniThrowFire              = AniPlayerUpper           (LTFALSE,    _A("UTF"),  _A("UTSFi"),    _A("UTCFi"),    _N,             _A("UTCSFi"));
	m_AniThrowFire2             = AniPlayerUpper           (LTFALSE,    _A("UTF"),  _A("UTSFi"),    _A("UTCFi"),    _N,             _A("UTCSFi"));
	m_AniThrowFire3             = AniPlayerUpper           (LTFALSE,    _A("UTF"),  _A("UTSFi"),    _A("UTCFi"),    _N,             _A("UTCSFi"));
	// 추가
	//m_AniThrowFirePos			= AniPlayerUpper		   (LTFALSE,    _A("UTFPo"),_A("UTSFi"),    _A("UTCFi"),    _N,             _A("UTCSFi"));
	m_AniThrowFirePos			= AniPlayerUpper		   (LTFALSE,    _A("UTFPo"), _N,			_N,				_N,             _N);
	...
	m_AniRifle2Unalert          = AniPlayerUpper           (LTTRUE,     _A("UR2Am"), _A("UR2SAm"),   _A("UR2CAm"),  _N,             _A("UR2CSAm"));
	...
	m_AniRifle2Fire2            = AniPlayerUpper           (LTFALSE,    _A("UR2Fi"), _A("UR2SFi"),   _A("UR2CFi"),  _N,             _A("UR2CSFi"));
	m_AniRifle2Fire3            = AniPlayerUpper           (LTFALSE,    _A("UR2Fi"), _A("UR2SFi"),   _A("UR2CFi"),  _N,             _A("UR2CSFi"));
	...
	m_AniRifle3Unalert          = AniPlayerUpper           (LTTRUE,     _A("UR3Am"), _A("UR3SAm"),   _A("UR3CAm"),  _N,             _A("UR3CSAm"));
	...
	m_AniRifle3Fire2            = AniPlayerUpper           (LTFALSE,    _A("UR3Fi"), _A("UR3SFi"),   _A("UR3CFi"),  _N,             _A("UR3CSFi"));
	m_AniRifle3Fire3            = AniPlayerUpper           (LTFALSE,    _A("UR3Fi"), _A("UR3SFi"),   _A("UR3CFi"),  _N,             _A("UR3CSFi"));
	m_AniRifle3Reload           = AniPlayerUpper           (LTFALSE,    _A("UR3Re"), _N,             _A("UR3CRe"),  _N,             _N);
	// 추가
	m_AniRifle3PreReload        = AniPlayerUpper           (LTFALSE,    _A("UR3RePr"), _N,             _A("UR3CRe"),  _N,             _N);
	m_AniRifle3PostReload       = AniPlayerUpper           (LTFALSE,    _A("UR3RePo"), _N,             _A("UR3CRe"),  _N,             _N);
	...
	// 광식 추가 : TimeBomb 형태의 무기
	//------------------------------------------------------------------------------------------------------------------
	//m_AniTimeBombUnalert		= AniPlayerUpper           (LTTRUE,     _A("UBUn"), _N,             _N,             _N,             _N);
	m_AniTimeBombUnalert		= AniPlayerUpper           (LTTRUE,     _A("UBAm"), _A("UBSAm"),    _A("UBCAm"),    _N,             _A("UTCSAm"));


    m_AniTimeBombAlert			= AniPlayerUpper           (LTTRUE,     _A("UBAl"), _N,             _N,             _N,             _N);
    m_AniTimeBombAim            = AniPlayerUpper           (LTTRUE,     _A("UBAm"), _A("UBSAm"),    _A("UBCAm"),    _N,             _A("UTCSAm"));
	m_AniTimeBombFirePre		= AniPlayerUpper		   (LTFALSE,    _A("UBFPr"), _N,			_N,				_N,             _N);    
	m_AniTimeBombFire           = AniPlayerUpper           (LTFALSE,    _A("UBFi"),  _A("UBSFi"),   _A("UBCFi"),    _N,             _A("UTCSFi"));
	m_AniTimeBombFire2          = AniPlayerUpper           (LTFALSE,    _A("UBFi"),  _A("UBSFi"),   _A("UBCFi"),    _N,             _A("UTCSFi"));
	m_AniTimeBombFire3          = AniPlayerUpper           (LTFALSE,    _A("UBFi"),  _A("UBSFi"),   _A("UBCFi"),    _N,             _A("UTCSFi"));
	m_AniTimeBombFirePos		= AniPlayerUpper		   (LTFALSE,    _A("UBFPo"), _N,			_N,				_N,             _N);	
	m_AniTimeBombReload         = AniPlayerUpper           (LTFALSE,    _A("UBRe"), _N,             _A("UBCRe"),    _N,             _N);
    m_AniTimeBombSelect         = AniPlayerUpper           (LTFALSE,    _A("UBSe"), _N,             _A("UBCRe"),    _N,             _N);
    m_AniTimeBombDeselect       = AniPlayerUpper           (LTFALSE,    _A("UBDe"), _N,             _A("UBCRe"),    _N,             _N);
	m_AniTimeBombAimLeanR		= AniPlayerUpper           (LTFALSE,	_A("UBAmR"),_N,				_A("UBCAmR"),	_N,				_N);
	m_AniTimeBombAimLeanL		= AniPlayerUpper           (LTFALSE,	_A("UBAmL"),_N,				_A("UBCAmL"),	_N,				_N);
	m_AniTimeBombFireLeanR		= AniPlayerUpper           (LTFALSE,	_A("UBFiR"),_N,				_A("UBCFiR"),	_N,				_N);
	m_AniTimeBombFireLeanL		= AniPlayerUpper           (LTFALSE,	_A("UBFiL"),_N,				_A("UBCFiL"),	_N,				_N);
	//------------------------------------------------------------------------------------------------------------------
	...
	m_AniHolsterFire2           = AniPlayerUpper           (LTFALSE,    _A("UHFi"), _A("UHSFi"),	_A("UHCFi"),	_N,             _A("UHCSFi"));
	m_AniHolsterFire3           = AniPlayerUpper           (LTFALSE,    _A("UHFi"), _A("UHSFi"),	_A("UHCFi"),	_N,             _A("UHCSFi"));
	...
	*/
	...
	m_AniPlaceFire2 			= AniPlayerUpper           (LTFALSE,    _A("UPlFi"), _A("UPlSFi"),	_A("UPlCFi"),	_N,             _A("UPlCSFi"));
	m_AniPlaceFire3				= AniPlayerUpper           (LTFALSE,    _A("UPlFi"), _A("UPlSFi"),	_A("UPlCFi"),	_N,             _A("UPlCSFi"));
	...
	*/
	...
	m_AniGadgetFire2			= AniPlayerUpper           (LTFALSE,    _A("UGFi"), _A("UGSFi"),	_A("UGCFi"),	_N,             _A("UGCSFi"));
	m_AniGadgetFire3			= AniPlayerUpper           (LTFALSE,    _A("UGFi"), _A("UGSFi"),	_A("UGCFi"),	_N,             _A("UGCSFi"));
	...
	*/
	...
	m_AniStarsFire2				= AniPlayerUpper           (LTFALSE,    _A("USFi"), _A("USSFi"),	_A("USCFi"),	_N,             _A("USCSFi"));
	m_AniStarsFire3				= AniPlayerUpper           (LTFALSE,    _A("USFi"), _A("USSFi"),	_A("USCFi"),	_N,             _A("USCSFi"));
	...
	*/
	...
	m_aapAniPlayerUppers[eRifle][eFire2][eCenter]		= &m_AniRifleFire2;
	...
	m_aapAniPlayerUppers[eRifle][eFire3][eCenter]		= &m_AniRifleFire3;
	...
	m_aapAniPlayerUppers[ePistol][eFire2][eCenter]		= &m_AniPistolFire2;
	...
	m_aapAniPlayerUppers[ePistol][eFire3][eCenter]		= &m_AniPistolFire3;
	...
	m_aapAniPlayerUppers[eMelee][eAimE][eCenter]		= &m_AniMeleeAimEmpty;
	...
	m_aapAniPlayerUppers[eThrow][eFirePre][eCenter]		= &m_AniThrowFirePre;
	m_aapAniPlayerUppers[eThrow][eFirePre][eLeft]		= &m_AniThrowFireLeanL;
	m_aapAniPlayerUppers[eThrow][eFirePre][eRight]		= &m_AniThrowFireLeanR;
	...
	m_aapAniPlayerUppers[eThrow][eFire2][eCenter]		= &m_AniThrowFire2;
	...
	m_aapAniPlayerUppers[eThrow][eFire3][eCenter]		= &m_AniThrowFire3;
	...
	m_aapAniPlayerUppers[eThrow][eFirePos][eCenter]		= &m_AniThrowFirePos;
	m_aapAniPlayerUppers[eThrow][eFirePos][eLeft]		= &m_AniThrowFireLeanL;
	m_aapAniPlayerUppers[eThrow][eFirePos][eRight]		= &m_AniThrowFireLeanR;
	...
	m_aapAniPlayerUppers[eRifle2][eFire2][eCenter]		= &m_AniRifle2Fire2;
	...
	m_aapAniPlayerUppers[eRifle2][eFire3][eCenter]		= &m_AniRifle2Fire3;
	...
	m_aapAniPlayerUppers[eRifle3][eFire2][eCenter]		= &m_AniRifle3Fire2;
	...
	m_aapAniPlayerUppers[eRifle3][eFire3][eCenter]		= &m_AniRifle3Fire3;
	...
	m_aapAniPlayerUppers[eRifle3][ePreReload][eCenter]	= &m_AniRifle3PreReload;
	m_aapAniPlayerUppers[eRifle3][ePreReload][eLeft]	= &m_AniRifle3PreReload;
	m_aapAniPlayerUppers[eRifle3][ePreReload][eRight]	= &m_AniRifle3PreReload;

	m_aapAniPlayerUppers[eRifle3][ePostReload][eCenter]	= &m_AniRifle3PostReload;
	m_aapAniPlayerUppers[eRifle3][ePostReload][eLeft]	= &m_AniRifle3PostReload;
	m_aapAniPlayerUppers[eRifle3][ePostReload][eRight]	= &m_AniRifle3PostReload;
	...
	// 광식 : TimeBomb
	//-------------------------------------------------------------------------------------------
	// [eTimeBomb] [Posture] [Lean]

	m_aapAniPlayerUppers[eTimeBomb][eUnalert][eCenter]		= &m_AniTimeBombUnalert;
	m_aapAniPlayerUppers[eTimeBomb][eUnalert][eLeft]		= &m_AniTimeBombUnalert;
	m_aapAniPlayerUppers[eTimeBomb][eUnalert][eRight]		= &m_AniTimeBombUnalert;
														
	m_aapAniPlayerUppers[eTimeBomb][eAlert][eCenter]		= &m_AniTimeBombAlert;
	m_aapAniPlayerUppers[eTimeBomb][eAlert][eLeft]			= &m_AniTimeBombAlert;
	m_aapAniPlayerUppers[eTimeBomb][eAlert][eRight]			= &m_AniTimeBombAlert;
														
	m_aapAniPlayerUppers[eTimeBomb][eAim][eCenter]			= &m_AniTimeBombAim;
	m_aapAniPlayerUppers[eTimeBomb][eAim][eLeft]			= &m_AniTimeBombAimLeanL;
	m_aapAniPlayerUppers[eTimeBomb][eAim][eRight]			= &m_AniTimeBombAimLeanR;

	m_aapAniPlayerUppers[eTimeBomb][eFirePre][eCenter]		= &m_AniTimeBombFirePre;
	m_aapAniPlayerUppers[eTimeBomb][eFirePre][eLeft]		= &m_AniTimeBombFireLeanL;
	m_aapAniPlayerUppers[eTimeBomb][eFirePre][eRight]		= &m_AniTimeBombFireLeanR;

	m_aapAniPlayerUppers[eTimeBomb][eFire][eCenter]			= &m_AniTimeBombFire;
	m_aapAniPlayerUppers[eTimeBomb][eFire][eLeft]			= &m_AniTimeBombFireLeanL;
	m_aapAniPlayerUppers[eTimeBomb][eFire][eRight]			= &m_AniTimeBombFireLeanR;

	m_aapAniPlayerUppers[eTimeBomb][eFire2][eCenter]		= &m_AniTimeBombFire2;
	m_aapAniPlayerUppers[eTimeBomb][eFire2][eLeft]			= &m_AniTimeBombFireLeanL;
	m_aapAniPlayerUppers[eTimeBomb][eFire2][eRight]			= &m_AniTimeBombFireLeanR;

	m_aapAniPlayerUppers[eTimeBomb][eFire3][eCenter]		= &m_AniTimeBombFire3;
	m_aapAniPlayerUppers[eTimeBomb][eFire3][eLeft]			= &m_AniTimeBombFireLeanL;
	m_aapAniPlayerUppers[eTimeBomb][eFire3][eRight]			= &m_AniTimeBombFireLeanR;

	m_aapAniPlayerUppers[eTimeBomb][eFirePos][eCenter]		= &m_AniTimeBombFirePos;
	m_aapAniPlayerUppers[eTimeBomb][eFirePos][eLeft]		= &m_AniTimeBombFireLeanL;
	m_aapAniPlayerUppers[eTimeBomb][eFirePos][eRight]		= &m_AniTimeBombFireLeanR;
														
	m_aapAniPlayerUppers[eTimeBomb][eReload][eCenter]		= &m_AniTimeBombReload;
	m_aapAniPlayerUppers[eTimeBomb][eReload][eLeft]			= &m_AniTimeBombReload;
	m_aapAniPlayerUppers[eTimeBomb][eReload][eRight]		= &m_AniTimeBombReload;
														
	m_aapAniPlayerUppers[eTimeBomb][eSelect][eCenter]		= &m_AniTimeBombSelect;
	m_aapAniPlayerUppers[eTimeBomb][eSelect][eLeft]			= &m_AniTimeBombSelect;
	m_aapAniPlayerUppers[eTimeBomb][eSelect][eRight]		= &m_AniTimeBombSelect;
														
	m_aapAniPlayerUppers[eTimeBomb][eDeselect][eCenter]		= &m_AniTimeBombDeselect;
	m_aapAniPlayerUppers[eTimeBomb][eDeselect][eLeft]		= &m_AniTimeBombDeselect;
	m_aapAniPlayerUppers[eTimeBomb][eDeselect][eRight]		= &m_AniTimeBombDeselect;
														
	m_aapAniPlayerUppers[eTimeBomb][eCarry][eCenter]		= &m_AniCarryBody;
	m_aapAniPlayerUppers[eTimeBomb][eCarry][eLeft]			= &m_AniCarryBody;
	m_aapAniPlayerUppers[eTimeBomb][eCarry][eRight]			= &m_AniCarryBody;
	//-------------------------------------------------------------------------------------------
	...
	m_aapAniPlayerUppers[eHolster][eFire2][eCenter]		= &m_AniHolsterFire2;
	...
	m_aapAniPlayerUppers[eHolster][eFire3][eCenter]		= &m_AniHolsterFire3;
	...
	*/
	...
	m_aapAniPlayerUppers[ePlace][eFire2][eCenter]		= &m_AniPlaceFire2;
	...
	m_aapAniPlayerUppers[ePlace][eFire3][eCenter]		= &m_AniPlaceFire3;
	...
	*/
	...
	m_aapAniPlayerUppers[eGadget][eFire2][eCenter]		= &m_AniGadgetFire2;
	...
	m_aapAniPlayerUppers[eGadget][eFire3][eCenter]		= &m_AniGadgetFire3;
	...
	*/
	...
	m_aapAniPlayerUppers[eStars][eFire2][eCenter]		= &m_AniStarsFire2;
	...
	m_aapAniPlayerUppers[eStars][eFire3][eCenter]		= &m_AniStarsFire3;
	...
	*/
	...
	// 광식 : 걸을 때 8 방향 추가 [일단 4방향만 있고 나머지는 clone]
	//--------------------------------------------------------------------------------
	m_aapAniPlayerLowers[eWalking][eStrafeLeftF][eCenter]	= &m_AniWalkStrafeLeft;
	m_aapAniPlayerLowers[eWalking][eStrafeLeftF][eLeft]		= &m_AniWalkStrafeLeft;
	m_aapAniPlayerLowers[eWalking][eStrafeLeftF][eRight]	= &m_AniWalkStrafeLeft;

	m_aapAniPlayerLowers[eWalking][eStrafeLeftB][eCenter]	= &m_AniWalkStrafeLeft;
	m_aapAniPlayerLowers[eWalking][eStrafeLeftB][eLeft]		= &m_AniWalkStrafeLeft;
	m_aapAniPlayerLowers[eWalking][eStrafeLeftB][eRight]	= &m_AniWalkStrafeLeft;

	m_aapAniPlayerLowers[eWalking][eStrafeRightF][eCenter]	= &m_AniWalkStrafeRight;
	m_aapAniPlayerLowers[eWalking][eStrafeRightF][eLeft]	= &m_AniWalkStrafeRight;
	m_aapAniPlayerLowers[eWalking][eStrafeRightF][eRight]	= &m_AniWalkStrafeRight;

	m_aapAniPlayerLowers[eWalking][eStrafeRightB][eCenter]	= &m_AniWalkStrafeRight;
	m_aapAniPlayerLowers[eWalking][eStrafeRightB][eLeft]	= &m_AniWalkStrafeRight;
	m_aapAniPlayerLowers[eWalking][eStrafeRightB][eRight]	= &m_AniWalkStrafeRight;
	//--------------------------------------------------------------------------------
	...
	// 광식 : 달릴 때 8방향 추가
	//--------------------------------------------------------------------------------
	m_aapAniPlayerLowers[eRunning][eStrafeLeftF][eCenter]	= &m_AniRunStrafeLeftF;
	m_aapAniPlayerLowers[eRunning][eStrafeLeftF][eLeft]		= &m_AniRunStrafeLeftF;
	m_aapAniPlayerLowers[eRunning][eStrafeLeftF][eRight]	= &m_AniRunStrafeLeftF;

	m_aapAniPlayerLowers[eRunning][eStrafeLeftB][eCenter]	= &m_AniRunStrafeLeftB;
	m_aapAniPlayerLowers[eRunning][eStrafeLeftB][eLeft]		= &m_AniRunStrafeLeftB;
	m_aapAniPlayerLowers[eRunning][eStrafeLeftB][eRight]	= &m_AniRunStrafeLeftB;

	m_aapAniPlayerLowers[eRunning][eStrafeRightF][eCenter]	= &m_AniRunStrafeRightF;
	m_aapAniPlayerLowers[eRunning][eStrafeRightF][eLeft]	= &m_AniRunStrafeRightF;
	m_aapAniPlayerLowers[eRunning][eStrafeRightF][eRight]	= &m_AniRunStrafeRightF;

	m_aapAniPlayerLowers[eRunning][eStrafeRightB][eCenter]	= &m_AniRunStrafeRightB;
	m_aapAniPlayerLowers[eRunning][eStrafeRightB][eLeft]	= &m_AniRunStrafeRightB;
	m_aapAniPlayerLowers[eRunning][eStrafeRightB][eRight]	= &m_AniRunStrafeRightB;
	//--------------------------------------------------------------------------------
	...
	// 광식 : 쭈구리고 앉아서 움직일 때 8 방향 추가
	//--------------------------------------------------------------------------------
	m_aapAniPlayerLowers[eCrouching][eStrafeLeftF][eCenter]	= &m_AniCrouchStrafeLeft;
	m_aapAniPlayerLowers[eCrouching][eStrafeLeftF][eLeft]	= &m_AniCrouchStrafeLeft;
	m_aapAniPlayerLowers[eCrouching][eStrafeLeftF][eRight]	= &m_AniCrouchStrafeLeft;

	m_aapAniPlayerLowers[eCrouching][eStrafeLeftB][eCenter]	= &m_AniCrouchStrafeLeft;
	m_aapAniPlayerLowers[eCrouching][eStrafeLeftB][eLeft]	= &m_AniCrouchStrafeLeft;
	m_aapAniPlayerLowers[eCrouching][eStrafeLeftB][eRight]	= &m_AniCrouchStrafeLeft;

	m_aapAniPlayerLowers[eCrouching][eStrafeRightF][eCenter]= &m_AniCrouchStrafeRight;
	m_aapAniPlayerLowers[eCrouching][eStrafeRightF][eLeft]	= &m_AniCrouchStrafeRight;
	m_aapAniPlayerLowers[eCrouching][eStrafeRightF][eRight]	= &m_AniCrouchStrafeRight;

	m_aapAniPlayerLowers[eCrouching][eStrafeRightB][eCenter]= &m_AniCrouchStrafeRight;
	m_aapAniPlayerLowers[eCrouching][eStrafeRightB][eLeft]	= &m_AniCrouchStrafeRight;
	m_aapAniPlayerLowers[eCrouching][eStrafeRightB][eRight]	= &m_AniCrouchStrafeRight;
	//--------------------------------------------------------------------------------

	//[SPIKE] 앉아서 점프 추가 
	m_aapAniPlayerLowers[eCrouching][eCrouchJump][eCenter]	= &m_AniCrouchJump_Jump;
	m_aapAniPlayerLowers[eCrouching][eCrouchJump][eLeft]	= &m_AniCrouchJump_Jump;
	m_aapAniPlayerLowers[eCrouching][eCrouchJump][eRight]	= &m_AniCrouchJump_Jump;
	
	m_aapAniPlayerLowers[eCrouching][eCrouchTuck][eCenter]	= &m_AniCrouchJump_Tuck;
	m_aapAniPlayerLowers[eCrouching][eCrouchTuck][eLeft]	= &m_AniCrouchJump_Tuck;
	m_aapAniPlayerLowers[eCrouching][eCrouchTuck][eRight]	= &m_AniCrouchJump_Tuck;
	
	m_aapAniPlayerLowers[eCrouching][eCrouchLand][eCenter]	= &m_AniCrouchJump_Land;
	m_aapAniPlayerLowers[eCrouching][eCrouchLand][eLeft]	= &m_AniCrouchJump_Land;
	m_aapAniPlayerLowers[eCrouching][eCrouchLand][eRight]	= &m_AniCrouchJump_Land;
	/////////////////////////////////////////////////////////////////////////////////////////
	...
	// 광식 : 수영 할 때 8 방향 추가
	//--------------------------------------------------------------------------------
	m_aapAniPlayerLowers[eSwimming][eStrafeLeftF][eCenter]	= &m_AniSwimForward;
	m_aapAniPlayerLowers[eSwimming][eStrafeLeftF][eLeft]	= &m_AniSwimForward;
	m_aapAniPlayerLowers[eSwimming][eStrafeLeftF][eRight]	= &m_AniSwimForward;

	m_aapAniPlayerLowers[eSwimming][eStrafeLeftB][eCenter]	= &m_AniSwimForward;
	m_aapAniPlayerLowers[eSwimming][eStrafeLeftB][eLeft]	= &m_AniSwimForward;
	m_aapAniPlayerLowers[eSwimming][eStrafeLeftB][eRight]	= &m_AniSwimForward;

	m_aapAniPlayerLowers[eSwimming][eStrafeRightF][eCenter]	= &m_AniSwimForward;
	m_aapAniPlayerLowers[eSwimming][eStrafeRightF][eLeft]	= &m_AniSwimForward;
	m_aapAniPlayerLowers[eSwimming][eStrafeRightF][eRight]	= &m_AniSwimForward;

	m_aapAniPlayerLowers[eSwimming][eStrafeRightB][eCenter]	= &m_AniSwimForward;
	m_aapAniPlayerLowers[eSwimming][eStrafeRightB][eLeft]	= &m_AniSwimForward;
	m_aapAniPlayerLowers[eSwimming][eStrafeRightB][eRight]	= &m_AniSwimForward;
	//--------------------------------------------------------------------------------
	...
	// 광식 추가
	//---------------------------------------------------------------------------------
	m_aapAniPlayerLowers[eJumping][eNone][eCenter]			= &m_AniJumpLand;
	m_aapAniPlayerLowers[eJumping][eNone][eLeft]			= &m_AniJumpLand;
	m_aapAniPlayerLowers[eJumping][eNone][eRight]			= &m_AniJumpLand;
	//---------------------------------------------------------------------------------
	...
	*/
	...
	//[MURSUM]	EndTimingCounter("CAnimatorPlayer::Init took");
...
/*
// Added By IN'T ==>
			if ((m_eWeapon>=kNumWeapons) || (m_ePosture>=kNumPostures) || m_eLean >= kNumLeans
				|| m_eMovement >= kNumMovements || m_eDirection >= kNumDirections )	//	eAniTrackerInvalid == -1
			{
				TRACE("missing ani %d/%d  %d/%d\n", m_eWeapon, m_ePosture, m_eMovement, m_eDirection);
...
*/
			...
			{
				// 광식 : Reload 시 Ani가 반복되는것을 방지 하려고..
			...
			// 광식 : 연사 되는 총과 연사가 되지 않는 총의 Fire Animation 을 구별하기 위해
			//-----------------------------------------------------------------------------
			LTBOOL bRepeat = LTTRUE;
			if( m_ePosture == eFire ||
				m_ePosture == eFire2 ||
				m_ePosture == eFire3 ||
				m_ePosture == eFirePre )
			{
				...
				if( pPlayer )
				{
					CWeapon* pCurWeapon = (CWeapon*)pPlayer->GetPlayerAttachments()->GetWeapon();
					if( pCurWeapon )
					{
						WEAPON const *pWeaponData = g_pWeaponMgr->GetWeapon(pCurWeapon->GetId());
						if( pWeaponData )
						{
							if( pWeaponData->m_nFireType >= 1)	// FireType 1 은 연사 방지
								bRepeat = LTFALSE;
						}
					}					
				}
			}
			else if( m_ePosture == eReload )
			{
				CPlayerObj *pPlayer = dynamic_cast<CPlayerObj*>(g_pLTServer->HandleToObject( m_hObject ));
				if( pPlayer )
				{
					...
					if( pCurWeapon )
					{
						...
						if( pWeaponData )
						{
							if( pWeaponData->nVectorsPerRound == 1 ) // 샷건류는 Reload를 반복해야 함.
							{
								bRepeat = LTFALSE;
							}
						}
			...
			/* // 광식 : eAniUpper, eAniLower 두개만 보내면 처리 가능하네...
			g_pLTServer->CPrint("eAniUpper [%d], m_eAniTrackerUpper [%d] || eAniLower [%d] m_eAniTrackerLower [%d]",
								eAniUpper, m_eAniTrackerUpper, eAniLower, m_eAniTrackerLower);
								*/
			SetAni(eAniUpper, m_eAniTrackerUpper, bRepeat);
	...
	if( AP_PLAYER_ANIM_DEBUG > 0.0f )
	{
		CPlayerObj *pPlayer = dynamic_cast<CPlayerObj*>(g_pLTServer->HandleToObject( m_hObject ));
		if( pPlayer )
		{
			uint32 dwID = g_pLTServer->GetClientID( pPlayer->GetClient() );
			if( dwID == AP_PLAYER_ANIM_DEBUG )
			{
				g_pLTServer->CPrint( "" );

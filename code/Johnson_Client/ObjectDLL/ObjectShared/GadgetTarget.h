...
class GadgetTarget : public Prop
{
	public :	// Methods...
		...
		void			KillDisablingSound();
		
		//[SPIKE]
		virtual LTVector GetInitPosTimeBomb(){ return LTVector(0,0,0);}
		virtual VOID SetInitPosTimeBomb(LTVector vInitPos){}
	...
	protected : // Methods...
		...
		virtual void	HandleStoppedMsg( const CParsedMsg &cMsg, HOBJECT hSender=LTNULL );
...
//[SPIKE]
extern GadgetTarget* g_pGadgetTarget;

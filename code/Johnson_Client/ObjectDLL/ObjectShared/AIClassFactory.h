...
#define DECLARE_AI_FACTORY_CLASS_ABSTRACT /##/
#define DECLARE_AI_FACTORY_CLASS /##/
#define DEFINE_AI_FACTORY_CLASS /##/

#define DECLARE_AI_FACTORY_CLASS_ABSTRACT_SPECIFIC /##/
#define DECLARE_AI_FACTORY_CLASS_SPECIFIC /##/
#define DEFINE_AI_FACTORY_CLASS_SPECIFIC /##/

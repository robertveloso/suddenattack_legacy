...
class CDestructible : public IAggregate
{
	public :
        ...
        void SetArmorPoints(LTFLOAT fap);
        ...
        LTFLOAT     GetHitPoints()          const;
		LTFLOAT     GetEnergy()		        const { return m_fEnergy; }
        LTFLOAT     GetArmorPoints()        const;
		...
		//[SPIKE]°­Á¦ Á×À½
		VOID		SetForceDeath(LTBOOL bDead){m_bDead = bDead;}

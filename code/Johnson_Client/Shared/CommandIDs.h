...
#define COMMAND_ID_STRAFE			9	//[SPIKE] 무기변경 슬롯(1,2,3,4,5,6) =========================
...
#define COMMAND_ID_NEXT_AMMO		60	//[SPIKE] 무기변경 슬롯(1,2,3,4,5,6) =========================
...
#define COMMAND_ID_RADIO_2			72
#define COMMAND_ID_HOLSTER			73	//[SPIKE] 무기변경 슬롯(1,2,3,4,5,6) =========================
...
#define COMMAND_ID_DUCKLOCK			92	//[SPIKE] 무기변경 슬롯(1,2,3,4,5,6) =========================
...
#define COMMAND_ID_COMPASS			101	//[SPIKE] 무기변경 슬롯(1,2,3,4,5,6) =========================
#define COMMAND_ID_SENSITIVITY_HIGH	102
#define COMMAND_ID_SENSITIVITY_LOW	103
#define COMMAND_ID_MOVE_BODY		104	//[SPIKE] 무기변경 슬롯(1,2,3,4,5,6) =========================

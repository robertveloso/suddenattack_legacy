...
// 광식 : SPACTATOR Mode 따로 제작
//enum {SA_TEAM_SPACTATOR, SA_TEAM_BLUE, SA_TEAM_RED, MAX_SA_TEAMS};
enum {SA_TEAM_BLUE, SA_TEAM_RED, MAX_SA_TEAMS};
...
// Edited By IN'T ==>
// Time : 2004-04-29 오전 10:06:43
//     void	Init(uint8 nID, const char *szName, uint32 nModel);
     void	Init(uint8 nID, const char *szName);
// Edited By IN'T <==
...
#else // _CLIENTBUILD
// Edited By IN'T ==>
// Time : 2004-04-29 오전 10:05:20
// 	uint8	AddTeam(const char *szName, uint32 nModel);
 	uint8	AddTeam(const char *szName, uint32 nTeamID = INVALID_TEAM);
// Edited By IN'T <==

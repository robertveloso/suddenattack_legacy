...
struct SURFACE
{
    ...
    LTBOOL  bShowsMark;
	char	szBulletHoleSpr[SRF_MAX_BULLETHOLE_SPR][SRF_MAX_FILE_PATH];
	char	szMeleeHoleSpr[SRF_MAX_BULLETHOLE_SPR][SRF_MAX_FILE_PATH];
	char	szSpecialMeleeHoleSpr[SRF_MAX_BULLETHOLE_SPR][SRF_MAX_FILE_PATH];
	...
	// Normal Impact FX
	char	szImpactFXName[SRF_MAX_IMPACTFX_COUNT][SRF_MAX_NAME_LENGTH];
	
	//[SPIKE] Explode Impact FX ==========================
	char	szExplodeImpactFXName[SRF_MAX_IMPACTFX_COUNT][SRF_MAX_NAME_LENGTH];
	/////////////////////////// ==============================================
	...
	//[SPIKE]
	LTBOOL	m_bEnableBulletDir;
	int		m_iImpactArriveCount;
...
class CSurfaceMgr : public CGameButeMgr
{
	public :
		...
		//[SPIKE] Special Attack Mode
		VOID	SetSpecialDamageMode(LTBOOL bSpeCialModeOn){m_bSpecialModeOn = bSpeCialModeOn;}
		LTBOOL  IsSpecialDamageMode(){ return m_bSpecialModeOn; }
		//==================================================
	private :

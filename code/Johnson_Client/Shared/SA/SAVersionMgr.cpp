...
// {8DAB7349-905C-4e2f-91D5-7660F5A603A3}
LTGUID GAMEGUID = 
{ 0x8dab7349, 0x905c, 0x4e2f, { 0x91, 0xd5, 0x76, 0x60, 0xf5, 0xa6, 0x3, 0xa3 } };

#endif

// This is used for folder paths and registry entries.  Don't put invalid characters into the name.
#ifdef _TO2DEMO
char const GAME_NAME[] = "SuddenAttack Demo";
#else
char const GAME_NAME[] = "SuddenAttack";
#endif
...
#else
static const char* s_szVersion		= "SuddenAttack Development Build 124 (DO NOT DISTRIBUTE)";
#endif // _TO2DEMO

static const char* s_szBuild		= "Build 124";
static const uint32 s_nBuildNumber = 124;
static const char* s_szNetVersion	= "1.0.0.3";
static const char* s_szNetGameName	= "SuddenAttack";
...
// ----------------------------------------------------------------------- //
//
//	ROUTINE:	CSAVersionMgr::CSAVersionMgr()
//
//	PURPOSE:	Constructor
//
// ----------------------------------------------------------------------- //

CSAVersionMgr::CSAVersionMgr() : CVersionMgr()
{
	g_pVersionMgr = this;
}
...
// ----------------------------------------------------------------------- //
//
//	ROUTINE:	CSAVersionMgr::GetVersion()
//
//	PURPOSE:	Get the current version string
//
// ----------------------------------------------------------------------- //

const char* CSAVersionMgr::GetVersion()
{
	return s_szVersion;
}
...
// ----------------------------------------------------------------------- //
//
//	ROUTINE:	CSAVersionMgr::GetSaveVersion()
//
//	PURPOSE:	Get the current save version 
//
// ----------------------------------------------------------------------- //

const uint32 CSAVersionMgr::GetSaveVersion()
{
...
// ----------------------------------------------------------------------- //
//
//	ROUTINE:	CSAVersionMgr:GetNetVersion()
//
//	PURPOSE:	Get the current net version 
//
// ----------------------------------------------------------------------- //

const char* CSAVersionMgr::GetNetVersion()
{
...
// ----------------------------------------------------------------------- //
//
//	ROUTINE:	CSAVersionMgr:GetNetGameName()
//
//	PURPOSE:	Get the net game name.
//
// ----------------------------------------------------------------------- //

const char* CSAVersionMgr::GetNetGameName()
{
...
// ----------------------------------------------------------------------- //
//
//	ROUTINE:	CSAVersionMgr::GetBuild()
//
//	PURPOSE:	Get the current build string
//
// ----------------------------------------------------------------------- //

const char* CSAVersionMgr::GetBuild()
{
	return s_szBuild;
}
...
// ----------------------------------------------------------------------- //
//
//	ROUTINE:	CSAVersionMgr::GetBuildGuid()
//
...
const LTGUID* CSAVersionMgr::GetBuildGuid()
{
	return &s_BuildGuid;
}

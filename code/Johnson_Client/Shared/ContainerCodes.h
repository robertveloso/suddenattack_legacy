...
#define DEFAULT_BUBBLE_TEXTURE		"FX\\Particles\\Tracerbubble0.dtx"
#define DEFAULT_BUBBLE_TEXTURE1		"FX\\Particles\\Tracerbubble1.dtx"
...
enum ContainerCode 
{
	...
	CC_GRAVITY=19,
	CC_TIMEBOMB_AREA= 20,	// ±¤½Ä Ãß°¡
	CC_MAX_CONTAINER_CODES=21
...
#define CC_TIMEBOMB_AREA_FLAG			(1<<20)		//	±¤½Ä Ãß°¡
...
inline uint8 IsSpriteFX( SurfaceType eST )
{
	uint8 nRet = LTNULL;

...
class CAnimator
{
	...
	protected :
		...
		// 광식 : Fire Ani를 총기 별로 다르게 주려고.. Rifle 연사, 권총 단발..
		void SetAni(Ani eAni, AniTracker eAniTracker, LTBOOL bRepeat = LTTRUE);
		void SetAniTwitch(Ani eAni, AniTracker eAniTracker, LTBOOL bRepeat = LTTRUE, LTBOOL bTwitch = LTFALSE);

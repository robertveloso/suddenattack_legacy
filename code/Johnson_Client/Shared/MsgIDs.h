...
#define MID_PLAYER_HH_WEAPON			101
#define MID_PLAYER_KICKBAN				102
#define MID_PLAYER_INFOCHANGE			103 // Both ways
#define MID_PRELOAD_WEAPON				104
#define	MID_PLAYER_STATE_CHANGE			105
#define MID_CHANGE_TEAM					106
...
#define MID_PLAYER_INFO					109
	...
	#define MID_PI_UPDATE_FIRST			3	// first update

#define MID_SERVER_TIME					110
#define MID_PLAYER_SCORED				111
#define MID_PLAYER_RESPAWN				112
#define MID_PICKUP_WEAPON				113
#define MID_PLAYER_MULTIPLAYER_INIT		114
#define MID_PLAYER_HEALTH				115
...
//Activation sub-messages
	...
	#define MID_ACTIVATE_WEAPON			5	// Client to Server : ±¤½Ä Ãß°¡
...
#define MID_PLAYER_ARMOR				123

#define MID_MISSION_INFO				124	// Client to server
	#define MI_BOMB_DEFUSED		0	//	ÇØÃ¼
	#define MI_BOMB_DETONATED	1	//	ÆøÆÄ
	#define MI_BOMB_PLANTED		2	//	¼³Ä¡
	#define MI_BOMB_LIMIT_TIME	3	//	ÆøÆÄ±îÁö ³²Àº½Ã°£

#define MID_BODY_HIT_SFX				125
#define MID_HIT_SFX						126
...
#define MID_COMPILE						135		////Not Used
...
#define MID_LIGHT_CYCLE_INFO			136		////Not Used
...
#define MID_END_GAME							184
	#define EG_NORMAL							0
	#define EG_TIME_OUT							1
	#define	EG_ALL_KILLED						2
...
//[MURSUM]===========================================================
#define MID_RESTART_LEVEL						188	
#define MID_END_LEVEL							189 // Client to server
//===================================================================
...
#define MID_PROJECTILE_FX						254 // Client to server
	#define MID_HE_GRENADE						0
	#define MID_FLASHBANG						1
	#define MID_SMOKE_GRENADE					2

#define MID_PLAYER_ATTACH						255 // Client <-> server
	#define MID_DETACH_DISPLAY					0
	#define MID_ATTACH_FIRST					1	
	#define MID_ATTACH_THIRD					2
	#define MID_DETACH_OBSERVER					3

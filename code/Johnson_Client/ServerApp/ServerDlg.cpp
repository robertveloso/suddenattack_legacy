...
char const REGPRODUCTNAME[] = "SuddenAttack";
...
DWORD CServerDlg::DoHost( )
{
	...
	CRegMgr32 regMgr;
	regMgr.Init();
	if( !regMgr.OpenKey( HKEY_LOCAL_MACHINE, "SOFTWARE", "GameHi Productions", (char*)REGPRODUCTNAME,
		(char *)REGPRODUCTVER ))
	{
		return false;
	}
...
BOOL CServerDlg::OnInitDialog() 
{
	...
	SetWindowText( "SA_Dedicated_Server" );
...
bool CServerDlg::AddResources( )
{
	...
	CRegMgr32 regMgr;
	regMgr.Init();
	if( !regMgr.OpenKey( HKEY_LOCAL_MACHINE, "SOFTWARE", "GameHi", (char*)REGPRODUCTNAME,
		(char *)REGPRODUCTVER ))
	{
		return false;
	}
...
bool CServerDlg::InitErrorLog( )
{
	...
	{
		m_sErrorLogFileName = "SAServer.log";
	}

...
# PROP Scc_ProjName ""$/SA/Johnson_Code/Johnson_Client/ClientRes/SA", KBSBAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe
...
# PROP Output_Dir "..\..\built\Release\ClientRes\SA"
# PROP Intermediate_Dir "..\..\built\Release\ClientRes\SA"
# PROP Ignore_Export_Lib 1
# PROP Target_Dir ""
# ADD BASE CPP /nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /YX /FD /c
# ADD CPP /nologo /MT /W3 /GX /Zi /O2 /I ".\\" /I "..\STLPORT-4.0\STLPORT" /I "..\shared" /I "..\shared\lang\en" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /profile /debug /machine:I386 /out:"..\..\built\Release\ClientRes\SA\CRes.dll"
# Begin Custom Build
TargetPath=\SA\Johnson_Code\Johnson_Client\built\Release\ClientRes\SA\CRes.dll
InputPath=\SA\Johnson_Code\Johnson_Client\built\Release\ClientRes\SA\CRes.dll
SOURCE="$(InputPath)"

"$(SA_REZ_DIR)\CRes.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
...
# PROP Output_Dir "..\..\..\Johnson_Built\Johnson_Client\debug\ClientRes\SA"
# PROP Intermediate_Dir "..\..\..\Johnson_Built\Johnson_Client\debug\ClientRes\SA"
# PROP Ignore_Export_Lib 1
# PROP Target_Dir ""
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"..\..\..\Lib\Debug\CRes.dll" /pdbtype:sept
# Begin Custom Build
TargetPath=\SA\Johnson_Code\Lib\Debug\CRes.dll
InputPath=\SA\Johnson_Code\Lib\Debug\CRes.dll
SOURCE="$(InputPath)"

"$(SA_MAIN_DIR)\game\CRes.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	Rem IncrediBuild_OutputFile $(TargetPath) 
...
# PROP Use_MFC 0
# PROP Use_Debug_Libraries 0
# PROP Output_Dir "..\..\built\Final\ClientRes\SA"
# PROP Intermediate_Dir "..\..\built\Final\ClientRes\SA"
# PROP Ignore_Export_Lib 1
# PROP Target_Dir ""
# ADD BASE CPP /nologo /MT /W3 /GX /O2 /I "..\STLPORT-4.0\STLPORT" /I "..\shared" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_FINAL" /YX /FD /c
# ADD CPP /nologo /MT /W3 /GX /Zi /O2 /I "..\STLPORT-4.0\STLPORT" /I "..\shared" /I "..\shared\lang\en" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_FINAL" /YX /FD /c
# ADD BASE MTL /nologo /D "NDEBUG" /mktyplib203 /o "NUL" /win32
# ADD MTL /nologo /D "NDEBUG" /mktyplib203 /o "NUL" /win32
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /nodefaultlib:"libc" /out:"..\..\built\Final\ClientRes\SA\CRes.dll" /Release
# SUBTRACT LINK32 /profile /pdb:none
# Begin Custom Build
TargetPath=\SA\Johnson_Code\Johnson_Client\built\Final\ClientRes\SA\CRes.dll
InputPath=\SA\Johnson_Code\Johnson_Client\built\Final\ClientRes\SA\CRes.dll
SOURCE="$(InputPath)"
...
SOURCE="$(InputPath)"
PreLink_Cmds=set GAME_REZ_DIR=\_Project\PROJECT_SA\Development\SA\Game
...
# Begin Custom Build
TargetPath=\SA\Johnson_Code\Johnson_Client\built\FinalDE\ClientRes\TO2\CRes.dll
InputPath=\SA\Johnson_Code\Johnson_Client\built\FinalDE\ClientRes\TO2\CRes.dll
SOURCE="$(InputPath)"
...
# Begin Custom Build
TargetPath=\SA\Johnson_Code\Johnson_Client\built\FinalES\ClientRes\TO2\CRes.dll
InputPath=\SA\Johnson_Code\Johnson_Client\built\FinalES\ClientRes\TO2\CRes.dll
SOURCE="$(InputPath)"
...
# Begin Custom Build
TargetPath=\SA\Johnson_Code\Johnson_Client\built\FinalIT\ClientRes\TO2\CRes.dll
InputPath=\SA\Johnson_Code\Johnson_Client\built\FinalIT\ClientRes\TO2\CRes.dll
SOURCE="$(InputPath)"
...
# Begin Custom Build
TargetPath=\SA\Johnson_Code\Johnson_Client\built\FinalFR\ClientRes\TO2\CRes.dll
InputPath=\SA\Johnson_Code\Johnson_Client\built\FinalFR\ClientRes\TO2\CRes.dll
SOURCE="$(InputPath)"
...
SOURCE=..\Shared\Lang\EN\ClientResShared.rc
# PROP Exclude_From_Build 1
# End Source File
# Begin Source File

...
// Create the control
//DEL LTBOOL CLTGUITextCtrl::Create (  	const char*	pText,
//DEL                                     uint32      nCommandID,
//DEL                                     uint32      nHelpID,
//DEL 									LPD3DXFONT	lpD3DFont,
//DEL 									CLTGUICommandHandler *pCommandHandler,
//DEL                                     uint32      nParam1,
//DEL                                     uint32      nParam2)
//DEL {
//DEL 	m_pCommandHandler	= pCommandHandler;
//DEL 
//DEL 	if (!SetFont(lpD3DFont))
//DEL 	{
//DEL         return LTFALSE;
//DEL 	}
//DEL 
...
//DEL 	}
//DEL 
//DEL 	CLTGUICtrl::Create(nCommandID, nHelpID, nParam1,nParam2);
//DEL 
//DEL     return LTTRUE;
//DEL }
...
// Set the font
//DEL LTBOOL CLTGUITextCtrl::SetFont(LPD3DXFONT lpFont)
//DEL {
//DEL 	if (!lpFont)
//DEL 	{
//DEL         return LTFALSE;
...
//DEL 
//DEL 	if (lpFont)
//DEL 		m_lpD3DFont = lpFont;
//DEL 
//DEL 	if (m_pString)
//DEL 	{
//DEL 		m_pString->SetFont(NULL);
//DEL 	}
//DEL 
//DEL     return LTTRUE;
//DEL }

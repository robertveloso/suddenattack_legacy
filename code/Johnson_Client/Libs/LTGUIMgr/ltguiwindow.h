...
public:
	...
	// ±¤½Ä
	LTBOOL	Create (HTEXTURE hFrame, uint16 nWidth, uint16 nHeight, float xRate, float yRate, LTBOOL bSimpleStretch = LTFALSE);
	...
	virtual void		PlaySelectSound( CLTGUICtrl* pCtrl ) {};
	virtual void		PlayClickSound( CLTGUICtrl* pCtrl ) {};
	...
	virtual void SetBasePos ( int nPosX, int nPosY );
	...
	// ±¤½Ä
	CLTGUIFrame*		GetMainFrameTx() { return &m_Frame; }

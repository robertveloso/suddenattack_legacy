...
# PROP Scc_ProjName ""$/SA/Johnson_Code/Johnson_Libs/RegMgr", JICCAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
RSC=rc.exe
...
# ADD CPP /nologo /MD /W3 /GX /Zi /O2 /I "..\lith" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /YX /FD /c
...
# ADD LIB32 /nologo /out:"..\built\Release\RegMgr.lib"
...
# PROP Output_Dir "..\..\Johnson_Built\Johnson_Client\debug\RegMgr"
# PROP Intermediate_Dir "..\..\Johnson_Built\Johnson_Client\debug\RegMgr"
# PROP Target_Dir ""
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:"..\..\Lib\Debug\Regmgr.lib"
...
# ADD CPP /nologo /MT /W3 /GX /Zi /O2 /I "..\lith" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_FINAL" /YX /FD /c
# ADD BASE RSC /l 0x409
# ADD RSC /l 0x409
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
...
# ADD LIB32 /nologo /out:"..\built\Final\RegMgr.lib"

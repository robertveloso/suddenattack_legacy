...
# PROP Scc_ProjName ""$/SA/Johnson_Code/Johnson_Libs/StdLith", TICCAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
RSC=rc.exe
...
# ADD CPP /nologo /MD /W3 /GX /Zi /O2 /Ob2 /I ".\\" /I "..\STLPORT-4.0\STLPORT" /I "..\zlib" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "NO_PROFILE" /D "NOT_USING_FULL" /FR /YX /FD /c
...
# ADD LIB32 /nologo /out:"..\built\Release\Lib_StdLith.lib"
...
# PROP Output_Dir "..\..\Johnson_Built\Johnson_Libs\Debug\Lib_StdLith"
# PROP Intermediate_Dir "..\..\Johnson_Built\Johnson_Libs\Debug\Lib_StdLith"
# PROP Target_Dir ""
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:"..\..\Lib\Debug\Lib_StdLith.lib"
...
# ADD CPP /nologo /MT /W3 /GX /Zi /O2 /Ob2 /I ".\\" /I "..\STLPORT-4.0\STLPORT" /I "..\zlib" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_FINAL" /D "NO_PROFILE" /FR /YX /FD /c
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:"..\built\Final\Lib_StdLith.lib"

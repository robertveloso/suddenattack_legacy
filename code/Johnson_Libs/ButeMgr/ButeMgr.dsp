...
# PROP Scc_ProjName ""$/SA/Johnson_Code/Johnson_Libs/ButeMgr", GFCCAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
RSC=rc.exe
...
# ADD CPP /nologo /MD /W3 /GX /Zi /O2 /I "..\STLPORT-4.0\STLPORT" /I "..\stdlith" /I "..\mfcstub" /I "..\cryptmgr" /I "..\lith" /D "NDEBUG" /D "_NOMFC" /D "WIN32" /D "_WINDOWS" /YX /FD /c
...
# ADD LIB32 /nologo /out:"..\built\release\ButeMgr.lib"
...
# PROP Output_Dir "..\..\Johnson_Built\Johnson_Client\Debug\ButeMgr"
# PROP Intermediate_Dir "..\..\Johnson_Built\Johnson_Client\Debug\ButeMgr"
# PROP Target_Dir ""
...
# ADD LIB32 /nologo /out:"..\..\Lib\Debug\ButeMgr.lib"
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo /out:"..\Libs\Release\ButeMgr.lib"
# ADD LIB32 /nologo /out:"..\built\Release\ButeMgrMfcDll.lib"
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo /out:"..\Libs\Debug\ButeMgr.lib"
# ADD LIB32 /nologo /out:"..\built\Debug\ButeMgrMfcDll.lib"
...
# ADD CPP /nologo /MT /W3 /GX /Zi /O2 /I "..\STLPORT-4.0\STLPORT" /I "..\stdlith" /I "..\mfcstub" /I "..\cryptmgr" /I "..\lith" /D "NDEBUG" /D "_NOMFC" /D "WIN32" /D "_WINDOWS" /D "_FINAL" /YX /FD /c
# ADD BASE RSC /l 0x409
# ADD RSC /l 0x409
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
...
# ADD LIB32 /nologo /out:"..\built\Final\ButeMgr.lib"
...
# ADD LIB32 /nologo /out:"..\built\Final\ButeMgrMfcDll.lib"

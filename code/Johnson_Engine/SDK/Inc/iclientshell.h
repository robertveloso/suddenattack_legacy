...
*/
	...
	virtual void SendPingToGameServer() = 0;
...
*/
	...
	//[MURSUM]
	virtual LTRESULT OnObjectAnimSwitch( HLOCALOBJ hObj, uint32 nAnimIndex, bool bLooping )
	{
		return LT_OK;
	}
	
	virtual void	HandleConeType( uint32 nConeType ) {}
	
	virtual void	LoadingStateNotify( int32 nState ) {};

	// [NOVICE]
	virtual LTRESULT OnObjectPitch( HOBJECT hObj, float fPitch )
	{
		return LT_OK;
	}
};
...
public:
	...
	//////////////////////////////////////////////////////////////////////////
	// [NOVICE]
	virtual LTRESULT OnObjectPitch(HOBJECT hObj, float fPitch) { return LT_OK; }
	//////////////////////////////////////////////////////////////////////////
	...
	virtual void SendPingToGameServer() {};
};

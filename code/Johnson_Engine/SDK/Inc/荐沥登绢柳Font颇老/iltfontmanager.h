...
*/
		virtual CUIFont* CreateFont(HTEXTURE hTex, 
									uint8    charw, 
									uint8    charh,
									uint16*   pMap = NULL) = 0; //modified by teseus from " uint8*  "
...
Used for: Text and UI.
*/
		virtual HTEXTURE	CharToTexture(uint16* pTTFData, uint32 dataSize, uint32 character, uint32 pointSize) = 0;//modified by teseus from " uint8*  "
...
Used for: Text and UI.
*/
		virtual HTEXTURE	StringToTexture(uint16* pTTFData, uint32 dataSize, char* pCharacters, uint32 pointSize) = 0; //modified by teseus from " uint8*  "
...
Used for: Text and UI.
*/
		virtual HTEXTURE	StringToTexture(uint16* pTTFData, uint32 dataSize, uint32* pCharacters, uint32 pointSize) = 0; //modified by teseus from " uint8*  "

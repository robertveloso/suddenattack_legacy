...
Used for: Audio.
*/
    virtual LTRESULT KillSound(HLTSOUND& hSound, bool bTerm=false) = 0;
...
*/
	...
	virtual LTRESULT SetFrequency(HLTSOUND& hSound, unsigned long dwFrequency) = 0;
};
...
*/
	...
	virtual void	SetReverbFilter( bool bUse ) = 0;

...
*/
		...
		//////////////////////////////////////////////////////////////////////////
		// [NOVICE] Pitch
		LTRESULT	(*SetObjectPitch)(HOBJECT hObj, const float fPitch );
		virtual LTRESULT GetObjectPitch(HLOCALOBJ hObj, float* pfPitch ) = 0;
		//////////////////////////////////////////////////////////////////////////
		...
		void	(*SetObjectPosNonTeleport)(HOBJECT hObj, const LTVector *pos);  //!
...
*/
	...
	// ±¤½Ä
	virtual LTRESULT SendSFXMessage(ILTMessage_Read *pMsg, const LTVector &pos,
		uint32 flags, HOBJECT hSender)=0;
        //uint32 flags, bool bVisibleCheck)=0;
	
	//[MURRSUM]
	virtual LTRESULT SendWeaponSFXMessage(ILTMessage_Read *pMsg, const LTVector &pos,
        uint32 flags)=0;
...
*/
	...
	HCLIENT (*GetClientFromID)(uint8 nID);
	void* (*GetClientUserDataFromID)(uint8 nID);
...
*/
	...
	LTRESULT (*SilentKickClient)(HCLIENT hClient);

...
*/
	...
	//[MURSUM] 어느 패킷도 안보낼경우 사용하자.
	//NETFLAG_ANIM_DONTSEND	=     (1<<3),
	//NETFLAG_POS_DONTSEND	=     (1<<4),
	//NETFLAG_ROT_DONTSEND	=     (1<<5),
	//애니메이션 종류를 결정
	NETFLAG_ANIM_HHWEAPON	=	  (1<<3),
	NETFLAG_ANIM_PLAYEROBJ	=	  (1<<4),
	NETFLAG_ANIM_BODY		=	  (1<<5),
	NETFLAG_ANIM_THROWMODEL	=	  (1<<6),
};

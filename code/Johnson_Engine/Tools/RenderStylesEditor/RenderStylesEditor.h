...
private:
	...
	vector<LPDIRECT3DTEXTURE8> m_TextureArray;		// The debug setting texture array (stores the real textures we use)...
	LPDIRECT3DTEXTURE8		   m_BackGndTexture;	// Background Image texture...
...
private:	
	...
	LPDIRECT3DTEXTURE8 LoadTexture(const char* szFilename);					// Load a texture file...	

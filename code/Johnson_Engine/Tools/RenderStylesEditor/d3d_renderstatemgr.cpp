...
bool CD3DRenderStateMgr::SetRenderStyleStates(CD3DRenderStyle* pRenderStyle, uint32 iRenderPass, vector<LPDIRECT3DTEXTURE8>& TextureList)
{
...
// NOTE: The texture list needs to change to be device independent...
	...
	for (uint32 iTexStage = 0; iTexStage < 4; ++iTexStage) {
		...
		case RENDERSTYLE_NOTEXTURE	  : PD3DDEVICE->SetTexture(iTexStage,NULL); break;
		case RENDERSTYLE_USE_TEXTURE1 : PD3DDEVICE->SetTexture(iTexStage,TextureList[0]); assert(TextureList.size() >= 1); break;	// Need to pull this sucker out of the texture list...
		case RENDERSTYLE_USE_TEXTURE2 : PD3DDEVICE->SetTexture(iTexStage,TextureList[1]); assert(TextureList.size() >= 2); break;
		case RENDERSTYLE_USE_TEXTURE3 : PD3DDEVICE->SetTexture(iTexStage,TextureList[2]); assert(TextureList.size() >= 3); break;
		case RENDERSTYLE_USE_TEXTURE4 : PD3DDEVICE->SetTexture(iTexStage,TextureList[3]); assert(TextureList.size() >= 4); break; }
		...
		switch (RenderPass.TextureStages[iTexStage].UAddress) {
		case RENDERSTYLE_UVADDR_WRAP				: PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_ADDRESSU,D3DTADDRESS_WRAP); break;
		case RENDERSTYLE_UVADDR_CLAMP				: PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_ADDRESSU,D3DTADDRESS_CLAMP); break;
		case RENDERSTYLE_UVADDR_MIRROR				: PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_ADDRESSU,D3DTADDRESS_MIRROR); break;
		case RENDERSTYLE_UVADDR_MIRRORONCE			: PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_ADDRESSU,D3DTADDRESS_MIRRORONCE); break; }
		switch (RenderPass.TextureStages[iTexStage].VAddress) {
		case RENDERSTYLE_UVADDR_WRAP				: PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_ADDRESSV,D3DTADDRESS_WRAP); break;
		case RENDERSTYLE_UVADDR_CLAMP				: PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_ADDRESSV,D3DTADDRESS_CLAMP); break;
		case RENDERSTYLE_UVADDR_MIRROR				: PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_ADDRESSV,D3DTADDRESS_MIRROR); break;
		case RENDERSTYLE_UVADDR_MIRRORONCE			: PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_ADDRESSV,D3DTADDRESS_MIRRORONCE); break; }
		switch (RenderPass.TextureStages[iTexStage].TexFilter) {
		case RENDERSTYLE_TEXFILTER_POINT			: PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MAGFILTER,D3DTEXF_POINT); PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MINFILTER,D3DTEXF_POINT); PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MIPFILTER,D3DTEXF_NONE); break;
		case RENDERSTYLE_TEXFILTER_BILINEAR			: PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MAGFILTER,D3DTEXF_LINEAR); PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MINFILTER,D3DTEXF_LINEAR); PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MIPFILTER,D3DTEXF_POINT); break;
		case RENDERSTYLE_TEXFILTER_TRILINEAR		: PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MAGFILTER,D3DTEXF_LINEAR); PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MINFILTER,D3DTEXF_LINEAR); PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MIPFILTER,D3DTEXF_LINEAR); break;
		case RENDERSTYLE_TEXFILTER_ANISOTROPIC		: PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MAGFILTER,D3DTEXF_ANISOTROPIC); PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MINFILTER,D3DTEXF_ANISOTROPIC); PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MIPFILTER,D3DTEXF_LINEAR); break; 
		case RENDERSTYLE_TEXFILTER_POINT_PTMIP		: PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MAGFILTER,D3DTEXF_ANISOTROPIC); PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MINFILTER,D3DTEXF_ANISOTROPIC); PD3DDEVICE->SetTextureStageState(iTexStage,D3DTSS_MIPFILTER,D3DTEXF_POINT); break; }
...
{
	D3DVIEWPORT8 vp; PD3DDEVICE->GetViewport(&vp);

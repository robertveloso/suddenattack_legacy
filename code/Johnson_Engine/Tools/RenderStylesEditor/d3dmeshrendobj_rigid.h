...
public:
	...
	void					Render(D3DMATRIX& WorldTransform,CD3DRenderStyle* pRenderStyle,vector<LPDIRECT3DTEXTURE8>& TextureList);	// NOTE: The texture list needs to change to be device independent...

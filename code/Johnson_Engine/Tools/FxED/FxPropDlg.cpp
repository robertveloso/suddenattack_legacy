...
CFxPropDlg::CFxPropDlg(CWnd* pParent) : CDialog(CFxPropDlg::IDD, pParent)
{
	m_pKey		 = NULL;
	m_pCollProps = NULL;
	m_nCurScrollPos = 0;
...
BOOL CFxPropDlg::CreateDlg(CKey *pKey, CFastList<FX_PROP> *pList, CWnd* pParent)
{
	m_pKey		 = pKey;
	m_pCollProps = pList;
	m_nCurScrollPos = 0;

	return Create(CFxPropDlg::IDD, pParent);
}

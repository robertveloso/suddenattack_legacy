...
//------------------------------------------------------------------
	...
	typedef void (*BspStatusFn)(CBspGen *pBspGen, CReal num);
	...
	public:
						...
						CBspGenOptions()
						{
							...
							m_bCapPolySize			= false;
							m_bAddHullMakers		= false;
							m_bUseOriginals			= false;
							m_bPostProcess			= true;
							m_nThreadsToUse			= 0;
						}
	...
	class CBspGen
	{
		...
		public:
			...
			// Set this so you can get status info while the tree is being generated.
			void			SetStatusFunction( BspStatusFn fn ) { m_StatusFn = fn; }

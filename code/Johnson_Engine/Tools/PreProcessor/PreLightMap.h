...
//------------------------------------------------------------------
	...
	public:
		...
		// Initialize our data with the specified shadow map.
		bool			CompressShadowMap(uint32 width, uint32 height, LM_DATA *pData);

		// The destination buffer MUST be at least LIGHTMAP_MAX_TOTAL_PIXELS in size.
		bool			DecompressShadowMap(LM_DATA *pData);
	...
	public:
		...
		// Tracks whether we're compressed as a shadow map or not.
		bool			m_bShadowMap;

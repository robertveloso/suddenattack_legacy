...
void CLightFragmentMaker::Execute()
{
	...
	for (; iCurLight != m_aWorldLights.end(); ++iCurLight)
	{
		...
		m_cLMM.SetProgressBar((float)(iCurLight - m_aWorldLights.begin()) / (float)m_aWorldLights.size());
	...
	{
		// Update the progress bar
		m_cLMM.SetProgressBar((float)(iCurOutline - m_aOutlines.begin()) / (float)m_aOutlines.size());
	...
	{
		// Update the progress bar
		m_cLMM.SetProgressBar((float)(iCurPoly - m_aTriangulations.begin()) / (float)m_aTriangulations.size());

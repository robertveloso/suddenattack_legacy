...
void COptionsDisplay::ResetToDefaultColors()
{
	...
	m_colorArray[kColorPatch]=						CDisplayColorItem("ColorPatch",			"Patch",			RGB(0, 100, 255));
	...
	m_colorArray[kColorPatchHandleFill]=			CDisplayColorItem("ColorPatchHandleFill",	"Patch Handle Fill",		RGB(0,0,0));
	m_colorArray[kColorSelPatchHandleFill]=			CDisplayColorItem("ColorSelPatchHandleFill",	"Sel Patch Handle Fill",RGB(255,0,0));

...
void CRegionView::InitTracker()
{
	...
	*/
	...
	// Set up the carve callback
	pRVTracker = new CRVCallbackSimple(UIE_CARVE_BRUSH, this, CRegionView::OnBrushCarve);
	m_cTrackerMgr.AddTracker(pRVTracker);
	...
	pRVTracker = new CRVCallbackSimple(UIE_MARKER_CENTER, this, CRegionView::OnCenterMarkerOnSelection);
	m_cTrackerMgr.AddTracker(pRVTracker);

	//setting patch resolution
	pRVTracker = new CRVTrackerMenuItem( UIE_SET_PATCH_RESOLUTION, this, OnSetPatchResolution, OnUpdateSetPatchResolution);
	m_cTrackerMgr.AddTracker( pRVTracker );
	...
	*/
	...
	m_cTrackerMgr.AddTracker( pRVTracker );
	pRVTracker = new CRVTrackerMenuItem( UIE_ADD_PATCH, this, OnAddPatch, OnUpdateAddPatch );
	m_cTrackerMgr.AddTracker( pRVTracker );
	...
	m_cTrackerMgr.AddTracker( pRVTracker );
	pRVTracker = new CRVCallbackSimple(UIE_PATCH_EDIT_MODE, this, CRegionView::SetPatchEditMode);
	m_cTrackerMgr.AddTracker( pRVTracker );

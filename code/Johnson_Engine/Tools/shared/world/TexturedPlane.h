...
class CTexturedPlane
{
	...
	public:
		...
		LTVector&			GetO()	{return O;}
		LTVector&			GetP()	{return P;}
		LTVector&			GetQ()	{return Q;}

		void				SetO(LTVector tempO)	{ O = tempO; }
		void				SetP(LTVector tempP)	{ P = tempP; }
		void				SetQ(LTVector tempQ)	{ Q = tempQ; }

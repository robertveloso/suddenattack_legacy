		...
		for( uint32 i = 0; i < mysize; i++ )
		{
			if( m_Props[i]->SameAs(pPropList->m_Props[i]) )
			{
				switch(m_Props[i]->m_Type)
				{
					case LT_PT_STRING: 
						{
							CStringProp* pProp1 = (CStringProp*)(m_Props[i]);
							CStringProp* pProp2 = (CStringProp*)(pPropList->m_Props[i]);
							if( !(pProp1->SameAs(pProp2)) )
								return false;
						}
						break;
					case LT_PT_VECTOR: 
						{
							CVectorProp* pProp1 = (CVectorProp*)(m_Props[i]);
							CVectorProp* pProp2 = (CVectorProp*)(pPropList->m_Props[i]);
							if( !(pProp1->SameAs(pProp2)) )
								return false;
						}
						break;
					case LT_PT_COLOR:  
						{
							CColorProp* pProp1 = (CColorProp*)(m_Props[i]);
							CColorProp* pProp2 = (CColorProp*)(pPropList->m_Props[i]);
							if( !(pProp1->SameAs(pProp2)) )
								return false;
						}
						break;
					case LT_PT_REAL:	
						{
							CRealProp* pProp1 = (CRealProp*)(m_Props[i]);
							CRealProp* pProp2 = (CRealProp*)(pPropList->m_Props[i]);
							if( !(pProp1->SameAs(pProp2)) )
								return false;
						}
						break;
					...
					case LT_PT_BOOL:   
						{
							CBoolProp* pProp1 = (CBoolProp*)(m_Props[i]);
							CBoolProp* pProp2 = (CBoolProp*)(pPropList->m_Props[i]);
							if( !(pProp1->SameAs(pProp2)) )
								return false;
						}
						break;
					...
					case LT_PT_ROTATION:
						{
							CRotationProp* pProp1 = (CRotationProp*)(m_Props[i]);
							CRotationProp* pProp2 = (CRotationProp*)(pPropList->m_Props[i]);
							if( !(pProp1->SameAs(pProp2)) )
								return false;
						}
						break;

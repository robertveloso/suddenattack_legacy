...
void TransferDir(CRezDir* pDir, const char* sParamPath) {
  ASSERT(pDir != NULL);
  ASSERT(sParamPath != NULL);
...
//---------------------------------------------------------------------------------------------------
int RezCompiler(const char* sCmd, const char* sRezFile, const char* sTargetDir, BOOL bLithRez) {
  ASSERT(sCmd != NULL);

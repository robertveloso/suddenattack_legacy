...
//	  void 			   UpdateClientStates();
		...
		// the mighty update.
		bool 			Update(int32 updateFlags, uint32 nCurTimeMS, bool bUpdateUnguaranteed=true);
	...
	public:
		...
		bool			SetInternalObjectSetup( void* pVoidSetup, LTObject* pObj );
		bool			SetPlaySoundInfo( PlaySoundInfo* pPlaySoundInfo, void* pVoidFileRef, void* pVoidSoundTrack );
	...
	public:
		...
		uint32			m_nSendClientInWorld;
		uint32			m_nSendFailPackets;

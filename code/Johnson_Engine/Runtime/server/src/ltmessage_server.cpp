...
*/
	const int nTotalSize	= 16;
	const int nLossSize		= 2;

	cPacket.WriteBits(cCompPos.m_Pos[0] >> nLossSize, nTotalSize - nLossSize);
	cPacket.WriteBits(cCompPos.m_Pos[1] >> nLossSize, nTotalSize - nLossSize);
	cPacket.WriteBits(cCompPos.m_Pos[2] >> nLossSize, nTotalSize - nLossSize);

...
#define IFLAG_DONTSEND			(1<<10)	//[MURSUM] 패킷으로 안날림~
...
public:
	...
	// [NOVICE 5/12/2005] Pitch 를 Unguaranteed 에 실어 보내기 위함.
	//////////////////////////////////////////////////////////////////////////
	const float		GetPitch() const				{ return m_fPitch; }
	void			SetPitch(const float fPitch, bool bNeedUpdate = false)
	{ m_fPitch = fPitch; m_bNeedPitchUpdate = (bNeedUpdate) ? true : m_bNeedPitchUpdate; }
	bool			DoesNeedPitchUpdate()			{ return m_bNeedPitchUpdate; }
	void			FinishPitchUpdate()				{ SetNeedPitchUpdate(false); }
	void			SetNeedPitchUpdate(bool bUpdate){ m_bNeedPitchUpdate = bUpdate; }
	//////////////////////////////////////////////////////////////////////////

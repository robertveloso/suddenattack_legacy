...
#define ANIMATION_LOWER_TABLE_d sizeof(g_Ani_Lower_Table) / sizeof(ANIMATION_TABLE)
ANIMATION_TABLE g_Ani_Lower_Table[] = 
{
	{	TEXT("Base"),		0,		2666,	false	},
	{	TEXT("LST"),		6,		2000,	true	},
	{	TEXT("LWF"),		7,		1500,	true	},
	{	TEXT("LWB"),		10,		1500,	true	},
	{	TEXT("LWL"),		9,		1800,	true	},
	{	TEXT("LWR"),		8,		1800,	true	},
	{	TEXT("LRF"),		12,		1000,	true	},
	{	TEXT("LRB"),		11,		1000,	true	},
	{	TEXT("LRL"),		17,		1200,	true	},
	{	TEXT("LRR"),		18,		1200,	true	},
	{	TEXT("LRLF"),		13,		1000,	true	},
	{	TEXT("LRLB"),		16,		1000,	true	},
	{	TEXT("LRRF"),		15,		1000,	true	},
	{	TEXT("LRRB"),		14,		1000,	true	},
	{	TEXT("LC"),			1,		2000,	true	},
	{	TEXT("LCF"),		2,		1400,	true	},
	{	TEXT("LCB"),		3,		1400,	true	},
	{	TEXT("LCL"),		4,		2000,	true	},
	{	TEXT("LCR"),		5,		2000,	true	},
	{	TEXT("LJJ"),		73,		250,	false	},	
	{	TEXT("LJL"),		72,		30,		false	},
	{	TEXT("LCJJ"),		74,		650,	false	},
	{	TEXT("LCLJ"),		75,		230,	false	},
};

#define ANIMATION_UPPER_TABLE_d sizeof(g_Ani_Upper_Table) / sizeof(ANIMATION_TABLE)
ANIMATION_TABLE g_Ani_Upper_Table[] = 
{
	{	TEXT("Base"),		0,		2666,	false	},
	{	TEXT("URAm"),		29,		2666,	true	},
	{	TEXT("URFi"),		30,		110,	false	},
	{	TEXT("URRe"),		31,		2500,	false	},
	{	TEXT("URSe"),		32,		666,	false	},
	{	TEXT("UPAm"),		38,		2666,	true	},
	{	TEXT("UPFi"),		39,		200,	false	},
	{	TEXT("UPRe"),		37,		2000,	false	},
	{	TEXT("UPSe"),		40,		500,	false	},
	{	TEXT("UMAm"),		27,		2666,	true	},
	{	TEXT("UMFi"),		24,		350,	false	},
	{	TEXT("UMFi2"),		25,		350,	false	},
	{	TEXT("UMFi3"),		26,		350,	false	},
	{	TEXT("UMSe"),		28,		500,	false	},
	{	TEXT("UTAm"),		23,		2666,	true	},
	{	TEXT("UTFPr"),		21,		750,	false	},
	{	TEXT("UTF"),		19,		33,		false	},
	{	TEXT("UTFPo"),		20,		750,	false	},
	{	TEXT("UTSe"),		22,		750,	false	},
	{	TEXT("UR2Am"),		34,		2666,	true	},
	{	TEXT("UR2Fi"),		35,		500,	false	},
	{	TEXT("UR2Re"),		33,		2333,	false	},
	{	TEXT("UR2Se"),		36,		666,	false	},
	{	TEXT("UR3Am"),		43,		2666,	true	},
	{	TEXT("UR3Fi"),		44,		900,	false	},
	{	TEXT("UR3Re"),		41,		733,	false	},
	{	TEXT("UR3RePr"),	42,		666,	false	},
	{	TEXT("UR3RePo"),	45,		833,	false	},
	{	TEXT("UR3Se"),		46,		833,	false	},
	{	TEXT("UBAm"),		70,		2666,	true	},
	{	TEXT("UBFi"),		69,		5000,	false	},
	{	TEXT("UBSe"),		71,		833,	false	},
};

#define ANIMATION_RECOIL_TABLE_d sizeof(g_Ani_Recoil_Table) / sizeof(ANIMATION_TABLE)
ANIMATION_TABLE g_Ani_Recoil_Table[] = 
{
	{	TEXT("Base"),		0,		2666,	false	},
	{	TEXT("RclBBD"),		47,		600,	false	},
	{	TEXT("RclBLLeg"),	48,		666,	false	},
	{	TEXT("RclBLSh"),	49,		666,	false	},
	{	TEXT("RclBRLeg"),	50,		666,	false	},
	{	TEXT("RclBRSh"),	51,		666,	false	},
	{	TEXT("RclFBD"),		52,		666,	false	},
	{	TEXT("RclFLLeg"),	53,		666,	false	},
	{	TEXT("RclFLSh"),	54,		666,	false	},
	{	TEXT("RclFRLeg"),	55,		666,	false	},
	{	TEXT("RclFRSh"),	56,		666,	false	},
};

#define ANIMATION_DEATH_TABLE_d sizeof(g_Ani_Death_Table) / sizeof(ANIMATION_TABLE)
ANIMATION_TABLE g_Ani_Death_Table[] = 
{
	{	TEXT("Base"),			0,		2666,	false	},
	{	TEXT("D_ARMBa"),		57,		1666,	false	},
	{	TEXT("D_ARMFr"),		58,		1333,	false	},
	{	TEXT("D_BOMB"),			59,		1000,	false	},
	{	TEXT("D_CHESTBa"),		60,		1266,	false	},
	{	TEXT("D_CHESTFr"),		61,		1266,	false	},
	{	TEXT("D_CROUCH"),		66,		1366,	false	},
	{	TEXT("D_HEADSHOTBa"),	62,		933,	false	},
	{	TEXT("D_HEADSHOTFr"),	63,		1000,	false	},
	{	TEXT("D_LEGBa"),		64,		1800,	false	},
	{	TEXT("D_LEGFr"),		65,		833,	false	},
	{	TEXT("Twitch"),			68,		333,	false	},
};
//-------------------------------------------------------------
								...
								bool bAllowReset)
{
	...
	i_client_shell->OnObjectAnimSwitch( pObject, animIndex, bLooping );
...
// 광식
static LTRESULT ReadAnimationInfo(CClientShell *pShell, 
								  LTObject* pObject,
								  CPacket_Read &cPacket)
{
	uint8 nUpperAni = cPacket.Readuint8();
	bool bUpperLoop = cPacket.Readbool();
	uint8 nLowerAni  = cPacket.Readuint8();
	bool bLowerLoop = cPacket.Readbool();
	bool bRecoilAni	= cPacket.Readbool();
	
	uint8 nRecoilAni = 0;
	if(bRecoilAni)
	{
		 nRecoilAni = cPacket.Readuint8();
	}
	...
	LTAnimTracker* pTracker = pModel->GetTracker(1);				
	if( pTracker )
	{
		uint8 nAnimIndex = (uint8)trk_GetCurAnimIndex(pTracker);					
		trk_Loop(pTracker, bUpperLoop);
		trk_Play(pTracker, true);					
		if( nAnimIndex != nUpperAni )
		{
			if( !trk_SetCurAnim(pTracker, nUpperAni, true) )
				return LT_OK;
			pModel->ResetCachedTransformNodeStates();
		}
	}
	else	// Tracker 가 없다면 Add... 
	{
		if(ilt_client->GetModelLT()->AddTracker((HOBJECT)pModel, 1) != LT_OK)
		{
			return LT_ERROR;
		}

		pTracker = pModel->GetTracker(1);
		if( !pTracker )
		{
			assert(false);
			return LT_ERROR;
		...
		LTRESULT dResult = SwitchModelAnim(	pShell, pObject, pModel, pTracker, nUpperAni, true, true, 0,  
												MODELINFO_RATEMODIFIER_DEFAULT, true, false);
		if (dResult != LT_OK) 
		{
			assert(false);
			return LT_ERROR;
		...
		pTracker->m_TimeRef.m_iWeightSet = 0;
		pTracker->m_Flags &= ~AT_REMOVE;					
	}

	pTracker = pModel->GetTracker(2);
	if( pTracker )
	{
		uint8 nAnimIndex = (uint8)trk_GetCurAnimIndex(pTracker);
		trk_Loop(pTracker, bLowerLoop);
		trk_Play(pTracker, true);
		if( nAnimIndex != nLowerAni )
		{
			if( !trk_SetCurAnim(pTracker, nLowerAni, true) )
				return LT_OK;
			pModel->ResetCachedTransformNodeStates();
		}
	}
	...
	{
		if(ilt_client->GetModelLT()->AddTracker((HOBJECT)pModel, 2) != LT_OK)
		{
			return LT_ERROR;
		}
		...
		pTracker->m_TimeRef.m_iWeightSet = 1;
		pTracker->m_Flags &= ~AT_REMOVE;
	}
	...
	if( bRecoilAni )
	{
		pTracker = pModel->GetTracker(44);
		if( pTracker )
		{
			uint8 nAnimIndex = (uint8)trk_GetCurAnimIndex(pTracker);
			trk_Loop(pTracker, false);
			trk_Play(pTracker, true);
			if( nAnimIndex != nRecoilAni )
			{
				if( !trk_SetCurAnim(pTracker, nRecoilAni, true) )
					return LT_OK;
				pModel->ResetCachedTransformNodeStates();
			}
		}
		...
		{
			if(ilt_client->GetModelLT()->AddTracker((HOBJECT)pModel, 44) != LT_OK)
			{
				return LT_OK;
			}
			...
			LTRESULT dResult = SwitchModelAnim(	pShell, pObject, pModel, pTracker, nRecoilAni, false, true, 0,  
												MODELINFO_RATEMODIFIER_DEFAULT, true, false);
			if (dResult != LT_OK) 
			{
				assert(false);
							 ...
							 bool bAllowReset)
{
	...
	ModelInstance *pInst = pObject ? ToModel( pObject ) : LTNULL ;
	...
	while (cPacket.Readbool())
	{
		...
		*/
		...
		if( pInst )
		{
			...
			// 광식
			//con_Printf(CONRGB(100,100,250), 1, "!!! AniIndex [%d] Loop [%d] Play [%d] AniTime [%d] AniRate [%f] AllowTran [%d] AllowReset [%d]",
			//									nAnimIndex, bLooping, bPlaying, nAnimTime, fAnimRate, bAllowTransition, bAllowReset );
			
			//handle updating the information with the info sent from the server (includes animation, etc)
			LTRESULT dResult = SwitchModelAnim(	pShell, pObject, pInst, pTracker, nAnimIndex, bLooping, bPlaying, nAnimTime,  
								    ...
								    CPacket_Read &cPacket)
{
    ...
    if (changeFlags & CF_FILENAMES) 
	{
		...
		dResult = so_ExtraInit(pObject, &objectSetup, false);
		if( LT_OK != dResult )
			return dResult;
    }
	...
	// 광식
	//--------------------------------------------------
	//if( pObject->m_ObjectType == OT_MODEL ) return LT_OK;
	//--------------------------------------------------
    ...
    if (changeFlags & (CF_MODELINFO|CF_FORCEMODELINFO)) 
	{
		if (pObject->m_ObjectType == OT_MODEL) 
		{
			// 광식 [Animation Packet 수정]
			//---------------------------------------------------------------
			if( cPacket.Readbool() )
			{
				/*
				uint8 nAni = cPacket.Readuint8();
				bool bTwitchAni = cPacket.Readbool();
				uint8 nTwitchAni = 0;
				if( bTwitchAni )
				{
					nTwitchAni = cPacket.Readint8();
				}
				...
				LTAnimTracker* pTracker = pModel->GetTracker(0xFF);				
				if( pTracker )
				{
					uint8 nAnimIndex = (uint8)trk_GetCurAnimIndex(pTracker);					
					trk_Loop(pTracker, false);
					...
					if( nAnimIndex != nAni )
					{
						if( !trk_SetCurAnim(pTracker, nAni, true) )
							return LT_OK;
						pModel->ResetCachedTransformNodeStates();
					}
				}
				...
				{
					if(ilt_client->GetModelLT()->AddTracker((HOBJECT)pModel, 0xFF) != LT_OK)
					{
						return LT_OK;
					}

					pTracker = pModel->GetTracker(0xFF);
					if( !pTracker )
					{
						assert(false);
						return LT_OK;
					...
					LTRESULT dResult = SwitchModelAnim(	pShell, pObject, pModel, pTracker, nAni, true, true, 0,  
															MODELINFO_RATEMODIFIER_DEFAULT, true, false);
					if (dResult != LT_OK) 
					{
						assert(false);
					...
					pTracker->m_TimeRef.m_iWeightSet = INVALID_MODEL_WEIGHTSET;
					pTracker->m_Flags &= ~AT_REMOVE;					
				}
				...
				if( bTwitchAni )
				{
					...
					if( pTracker )
					{
						...
						if( nAnimIndex != nAni )
						{
							if( !trk_SetCurAnim(pTracker, nTwitchAni, true) )
								return LT_OK;
							pModel->ResetCachedTransformNodeStates();
						}
					}
					else	// Tracker 가 없다면 Add... 
					{
						...
						LTRESULT dResult = SwitchModelAnim(	pShell, pObject, pModel, pTracker, nTwitchAni, true, true, 0,  
																MODELINFO_RATEMODIFIER_DEFAULT, true, false);
						if (dResult != LT_OK) 
						{
							assert(false);
						...
						pTracker->m_TimeRef.m_iWeightSet = 4;
						pTracker->m_Flags &= ~AT_REMOVE;					
					}
				}
				*/
				uint8 nAni = cPacket.Readuint8();
				bool bLoop = cPacket.Readbool();
				//uint16 nAniLength = cPacket.Readuint16();				
				uint16 nAniLength = 0;
				bool bTwitchAni = cPacket.Readbool();
				uint8 nTwitchAni = 0;
				uint16 nTwitchAniLength = 0;
				if(bTwitchAni)
				{
					nAniLength = cPacket.Readuint16();
					nTwitchAni = cPacket.Readint8();
				}
				...
				if( pTracker )
				{
					uint32 nAnimTime = (nAniLength + (MODELINFO_ANIMTIME_RES - 1));
					SwitchModelAnim( pShell, pObject, pModel, pTracker, nAni, bLoop, true,
										 nAnimTime, 1.0f, !(changeFlags & CF_NEWOBJECT), true);
						pTracker->m_TimeRef.m_iWeightSet = INVALID_MODEL_WEIGHTSET;
						pTracker->m_Flags &= ~AT_REMOVE;
				}
				...
				if( bTwitchAni )
				{
					...
					if( pTracker )
					{
						SwitchModelAnim( pShell, pObject, pModel, pTracker, nTwitchAni, false, true,
										 0, 1.0f, !(changeFlags & CF_NEWOBJECT), true);
						pTracker->m_TimeRef.m_iWeightSet = 4;
						pTracker->m_Flags &= ~AT_REMOVE;
					}
					else
					{
						...
						dResult = SwitchModelAnim(	pShell, pObject, pModel, pTracker, nTwitchAni, false, true, 0,  
													MODELINFO_RATEMODIFIER_DEFAULT, true, true);
						if (dResult != LT_OK) 
						{
							assert(false);
							return LT_OK;
			...
			{
				//uint8 nMainAni = cPacket.Readuint8();
				//bool bMainLoop = cPacket.Readbool();
				//uint16 nMainLenght = cPacket.Readuint16();
				
				uint8 nUpperAni = cPacket.Readuint8();
				bool bUpperLoop = cPacket.Readbool();
				////////////uint16 nUpperLength = cPacket.Readuint16();

				uint8 nLowerAni  = cPacket.Readuint8();
				bool bLowerLoop = cPacket.Readbool();
				////////////uint16 nLowerLength = cPacket.Readuint16();

				bool bRecoilAni = cPacket.Readbool();
				uint8 nRecoilAni = 0;
				uint16 nRecoilLength = 0;
				if( bRecoilAni )
				{
					nRecoilAni = cPacket.Readuint8();
					////////////nRecoilLength = cPacket.Readuint16();
				}
				...
				CHECK_PARAMS2(pModel);
				if( pModel )
					TagTrackersForRemove(pModel);

				uint32 nAnimTime;
				LTAnimTracker* pTracker = LTNULL;

				pTracker = pModel->GetTracker(0xFF);			// Main Tracker
				if( pTracker )
				{
					//nAnimTime = (nMainLenght + (MODELINFO_ANIMTIME_RES - 1));
					//SwitchModelAnim( pShell, pObject, pModel, pTracker, nMainAni, bMainLoop, true,
					SwitchModelAnim( pShell, pObject, pModel, pTracker, 0, true, true,
										 0, 1.0f, !(changeFlags & CF_NEWOBJECT), true);
						pTracker->m_TimeRef.m_iWeightSet = INVALID_MODEL_WEIGHTSET;
						pTracker->m_Flags &= ~AT_REMOVE;
				}

				pTracker = pModel->GetTracker(1);				// Upper Tracker
				if( pTracker )
				{
					//--------------------------------------------------------------
					ModelAnim *pAnim = pModel->GetModelDB()->GetAnim(nUpperAni);
					uint32 nAniTime = pAnim->GetAnimTime();
					//const char* szName = pAnim->GetName();
					//con_Printf(CONRGB(100,100,250), 1, "!!! AniIndex [%d] AniLength [%d] AniName [%s]",
					//									nUpperAni, nAniTime, szName );
					//--------------------------------------------------------------

					////////////nAnimTime = (nUpperLength + (MODELINFO_ANIMTIME_RES - 1));
					nAnimTime = (nAniTime + (MODELINFO_ANIMTIME_RES - 1));
					SwitchModelAnim( pShell, pObject, pModel, pTracker, nUpperAni, bUpperLoop, true,
									 nAnimTime,/*0,*/ 1.0f, !(changeFlags & CF_NEWOBJECT), true);
					pTracker->m_TimeRef.m_iWeightSet = 0;
					pTracker->m_Flags &= ~AT_REMOVE;
				}
				else
				{
					...
					dResult = SwitchModelAnim(	pShell, pObject, pModel, pTracker, nUpperAni, bUpperLoop, true, 0,  
												MODELINFO_RATEMODIFIER_DEFAULT, true, true);
					if (dResult != LT_OK) 
					{
						assert(false);
				...
				pTracker = pModel->GetTracker(2);				// Lower Tracker
				if( pTracker )
				{
					//--------------------------------------------------------------
					ModelAnim *pAnim = pModel->GetModelDB()->GetAnim(nLowerAni);
					uint32 nAniTime = pAnim->GetAnimTime();
					//const char* szName = pAnim->GetName();
					//con_Printf(CONRGB(100,100,250), 1, "!!! AniIndex [%d] AniLength [%d] AniName [%s]",
					//									nLowerAni, nAniTime, szName );
					//--------------------------------------------------------------

					////////////nAnimTime = (nLowerLength + (MODELINFO_ANIMTIME_RES - 1));
					nAnimTime = (nAniTime + (MODELINFO_ANIMTIME_RES - 1));
					SwitchModelAnim( pShell, pObject, pModel, pTracker, nLowerAni, bLowerLoop, true,
										 nAnimTime,/*0,*/ 1.0f, !(changeFlags & CF_NEWOBJECT), true);
						pTracker->m_TimeRef.m_iWeightSet = 1;
						pTracker->m_Flags &= ~AT_REMOVE;
				}
				else
				{
					...
					dResult = SwitchModelAnim(	pShell, pObject, pModel, pTracker, nLowerAni, bLowerLoop, true, 0,  
												MODELINFO_RATEMODIFIER_DEFAULT, true, true);
					if (dResult != LT_OK) 
					{
						assert(false);
				...
				if( bRecoilAni )
				{
					pTracker = pModel->GetTracker(44);				// Recoil Tracker
					if( pTracker )
					{
						//--------------------------------------------------------------
						ModelAnim *pAnim = pModel->GetModelDB()->GetAnim(nLowerAni);
						...
						////////////nAnimTime = (nRecoilLength + (MODELINFO_ANIMTIME_RES - 1));
						nAnimTime = (nAniTime + (MODELINFO_ANIMTIME_RES - 1));
						SwitchModelAnim( pShell, pObject, pModel, pTracker, nRecoilAni, false, true,
											 nAnimTime, 1.0f, !(changeFlags & CF_NEWOBJECT), true);
							pTracker->m_TimeRef.m_iWeightSet = 4;
							pTracker->m_Flags &= ~AT_REMOVE;
					}
					else
					{
						...
						dResult = SwitchModelAnim(	pShell, pObject, pModel, pTracker, nRecoilAni, false, true, 0,  
													MODELINFO_RATEMODIFIER_DEFAULT, true, true);
						if (dResult != LT_OK) 
						{
							assert(false);
    ...
    if (changeFlags & (CF_POSITION|CF_TELEPORT)) 
	{
		...
		// 광식[05.06.17]
		//-------------------------------------------------------------------------------------
		//con_Printf(CONRGB(100,100,250), 1, "!!!!!!!!!!!!!!!!pd_OnObjectMove CF_POSITION ");
		//-------------------------------------------------------------------------------------
    ...
    if (changeFlags & CF_ATTACHMENTS) 
	{
        ...
        while ((childID = cPacket.Readuint16()) != INVALID_OBJECTID) 
		{
			...
			// 광식 : Game 에서 offset을 0으로 setting
			//-------------------------------------------------------------
			/*
		...
		*/
		...
		if( pObject->m_ObjectType == OT_MODEL )
		{
			...
			for(uint32 nCurrPiece = 0; nCurrPiece < MAX_PIECES_PER_MODEL / 32; nCurrPiece++)
			{
				pInst->m_HiddenPieces[nCurrPiece] = 0;
			}
		}
    }

	// Character 모델을 Game 에서 모두 똑같이 Setting 해서 모두 삭제 함.
	//------------------------------------------------------------------
	/*
	if (changeFlags & CF_DIMS)
	{
		...
		pObject->SetDims(CLTMessage_Read::ReadCompLTVector(cPacket));
	}
	*/
	//------------------------------------------------------------------
	if( changeFlags & CF_DIMS )
	{
		LTVector vDims(24.0f, 66.0f, 24.0f);
		pObject->SetDims(vDims);		
	}
...
static LTRESULT ReadNewObjectInfo(CPacket_Read &cPacket, InternalObjectSetup *pStruct, CPacket_Write &cSFXData) 
{
	...
	// 광식 : 원래는 LTVector 를 사용하고 있던 것을 압축했다가 완전 삭제..
	//pStruct->m_pSetup->m_GlobalForceOverride = cPacket.ReadLTVector();
	//pStruct->m_pSetup->m_GlobalForceOverride = CLTMessage_Read::ReadCompLTVector(cPacket);
	//-----------------------------------------------------------------------------
	pStruct->m_pSetup->m_GlobalForceOverride.Init();
	//-----------------------------------------------------------------------------
...
static LTRESULT OnYourIDPacket(CClientShell *pShell, CPacket_Read &cPacket) 
{
	...
	//[MURSUM] Loading Notify
	g_pClientMgr->SetLoadingState( L_RECV_MY_ID );
...
static LTRESULT OnLoadWorldPacket(CClientShell *pShell, CPacket_Read &cPacket) 
{
	...
	//[MURSUM] Loading Notify
	g_pClientMgr->SetLoadingState( L_LOAD_WORLD );
	...
	g_pClientMgr->m_ClientNetMgr.SendPacket(CPacket_Read(cResponse), pShell->m_HostID);
...
{
	dsi_ConsolePrint( "[ENGINE] OnUnloadWorldPacket" );
	//[MURSUM]
	/*
	pShell->m_ClientObjectID = (uint16)-1;
									...
									uint16        flags) 
{
    ...
    if (flags & CF_NEWOBJECT) 
	{
        ...
        if (dResult != LT_OK) 
		{
			...
			dsi_ConsolePrint("Error adding object Result: %d  #%d to world. (%0.2f, %0.2f, %0.2f)",
							 dResult, objectID, VEC_EXPAND(vWorldPos));
            //return dResult;
        }
    }
    else 
...
static LTRESULT OnUpdatePacket(CClientShell *pShell, CPacket_Read &cPacket) 
{
	...
	while (!cPacket.EOP()) 
	{
		...
		if (cPacket.Tell() != nUpdateStart + nUpdateSize)
		{
			// 광식
			//-------------------------------------------------
			con_WhitePrintf("[Error] UpdateSize [%d], UpdateStart [%d], flags & CF_OTHER [%d]",
							 nUpdateSize, nUpdateStart, (flags & CF_OTHER) );
			if( flags )
			{
				con_WhitePrintf("[Error] objectID [%d] ReadObjectSubPacket [%d]", objectID, dResult);
			}
			else
			{
				con_WhitePrintf("[Error] subType [%d]", subType);
				if( subType == UPDATESUB_PLAYSOUND )
				{
					con_WhitePrintf("[Error] ReadPlaySound [%d]", dResult);
				}
				else if( subType == UPDATESUB_SOUNDTRACK )
				{
					con_WhitePrintf("[Error] flags [%d], objectID [%d], dResult [%d]", flags, objectID, dResult);
				}
				else if( subType == UPDATESUB_OBJECTREMOVES )
				{
					con_WhitePrintf("[Error] ReadObjectRemoves [%d]", dResult);
				}
			}
			//-------------------------------------------------
			ASSERT(FALSE);			
    ...
    while (!cPacket.EOP())
	{
        ...
        else 
		{
            ...
            if (flags & UUF_POS)
			{
				...
				if (cPacket.Readbool())
					//newVel = CLTMessage_Read::ReadCompLTVector(cPacket);
					newVel = CLTMessage_Read_Client::ReadCompPos(cPacket);
				else
					newVel.Init();
				...
				if (pObject) 
				{
					...
					if (!bSameAsLast)
					{
						...
						if (!vCurCompPos.NearlyEquals(newPos, 0.001f))
						{
							// 광식[05.06.17]
							//-------------------------------------------------------------------------------------
							//con_Printf(CONRGB(100,100,250), 1, "!!!!!!!!!!!!!!!!pd_OnObjectMove bSameAsLast ");
							//-------------------------------------------------------------------------------------
			...
			if ( flags & UUF_PITCH )
			{
				fPitch = CLTMessage_Read::ReadCompPitch(cPacket);

				if (pObject)
				{
					i_client_shell->OnObjectPitch( (HOBJECT)pObject, fPitch );
				}
			}
            ...
            if (flags & UUF_ANIMINFO) 
			{
				...
				uint8 nUpperAni = cPacket.Readuint8();
				//---------------------------------------------------------------------------
				bool bUpperLoop = cPacket.Readbool();		// 추가
				//---------------------------------------------------------------------------
				uint8 nLowerAni  = cPacket.Readuint8();
				//---------------------------------------------------------------------------
				bool bLowerLoop = cPacket.Readbool();		// 추가
				bool bRecoilAni	= cPacket.Readbool();
				uint8 nRecoilAni = 0;
				if(bRecoilAni)
				{
				...
				if( pTracker )
				{
					...
					trk_Play(pTracker, true);	
					//if( nAnimIndex != nUpperAni )
					if( nAnimIndex != nUpperAni || trk_IsStopped(pTracker) )					
					{
						if( !trk_SetCurAnim(pTracker, nUpperAni, true) )
							return LT_OK;
						pModel->ResetCachedTransformNodeStates();
				...
				if( pTracker )
				{
					...
					if( nAnimIndex != nLowerAni || trk_IsStopped(pTracker) )
					{						
						if( !trk_SetCurAnim(pTracker, nLowerAni, true) )
							return LT_OK;
						pModel->ResetCachedTransformNodeStates();
				...
				//---------------------------------------------------------------------------				
				//ReadAnimInfo(pShell, pObject, cPacket, true, false);
            }
        }
    }
...
{
	// 광식
	ilt_client->SetGlobalLightDir(CLTMessage_Read::ReadCompLTVector(cPacket));
	ilt_client->SetGlobalLightColor(CLTMessage_Read::ReadCompLTVector(cPacket));
...
static LTRESULT OnWeaponSFXMessage(CClientShell *pShell, CPacket_Read &cPacket) 
{
	if (i_client_shell != NULL) 
	{
		CPacket_Write cWrapMsg;
		cWrapMsg.Writeuint8(6);
		cWrapMsg.Writeuint64( cPacket.Readuint64() ); //8+8+16+16+16
		CPacket_Read cFinalMsg(cWrapMsg);
		
        i_client_shell->SpecialEffectNotify(LTNULL, CSubMsg_Client(cFinalMsg));
    }
...
static LTRESULT OnClientObjectID(CClientShell *pShell, CPacket_Read &cPacket) 
{
	...
	//[MURSUM] Loading Notify
	g_pClientMgr->SetLoadingState( L_RECV_CLIENT_OBJ_ID );
    return LT_OK;
}
...
static LTRESULT OnPreloadListPacket(CClientShell *pShell, CPacket_Read &cPacket) 
{
    ...
    switch (type) 
	{
        case PRELOADTYPE_START:
        {
			...
			//[MURSUM] Loading Notify
			g_pClientMgr->SetLoadingState( L_START_PRELOAD );
        }
        break;
        ...
        case PRELOADTYPE_END:
        {
			...
			//[MURSUM] Loading Notify
			g_pClientMgr->SetLoadingState( L_END_PRELOAD );
		}
		break;
...
void CClientShell::DisconnectNotify(CBaseConn *id, EDisconnectReason eDisconnectReason ) 
{
    ...
    if (i_client_shell != NULL) 
	{
		...
		else if( eDisconnectReason == DISCONNECTREASON_SILENT_KICKED )
		{
			wParam = LT_SILENT_REJECTED;
		}
...
void CClientShell::InitHandlers() 
{
	...
	g_ShellHandlers[SMSG_WEAPON_SFX_MESSAGE].fn = &OnWeaponSFXMessage;
}
...
LTRESULT CClientShell::ProcessPackets(void) 
{
    ...
    g_pClientMgr->m_ClientNetMgr.StartGettingPackets();

	CPacket_Read cPacket;
	CBaseConn *pSender;
    while (g_pClientMgr->m_ClientNetMgr.GetPacket(NETMGR_TRAVELDIR_SERVER2CLIENT, &cPacket, &pSender)) 
	{
	...
	if( nCount >= 4000 )
	{
		con_WhitePrintf("!!!!!!!!!!!!!!!!!!!!!!!!!!Update Packet Size [%d] ", cPacket.Size());
		return LT_ERROR;
	}	
	*/
    ...
    g_pClientMgr->m_ClientNetMgr.EndGettingPackets();
    return dResult;
}
...
void CClientShell::SendGoodbye(void) 
{
	...
	g_pClientMgr->m_ClientNetMgr.SendPacket(CPacket_Read(cGoodbye), m_HostID);
}

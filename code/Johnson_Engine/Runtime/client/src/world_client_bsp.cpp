...
public:
	...
	// ±¤½Ä
	bool IntersectSegmentClient(IntersectQuery *pQuery, IntersectInfo *pInfo);
...
// ±¤½Ä
bool CWorldClientBSP::IntersectSegmentClient(IntersectQuery *pQuery, IntersectInfo *pInfo)
{
	return i_IntersectSegmentClient(pQuery, pInfo, &world_tree);
}

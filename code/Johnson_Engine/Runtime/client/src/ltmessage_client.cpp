...
*/
	...
	cCompPos.m_Pos[0] = ((cPacket.ReadBits(nTotalSize - nLossSize)) << nLossSize);
	cCompPos.m_Pos[1] = ((cPacket.ReadBits(nTotalSize - nLossSize)) << nLossSize);
	cCompPos.m_Pos[2] = ((cPacket.ReadBits(nTotalSize - nLossSize)) << nLossSize);

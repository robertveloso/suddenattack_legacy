...
public:
	...
	void					BeginRender(CD3DRenderStyle* pRenderStyle, uint32 iRenderPass);
...
private:
	inline uint32			SetTransformsToBoneSet(BoneSetListItem* pBoneSet,D3DMATRIX* pTransforms, uint32 nNumMatrices);

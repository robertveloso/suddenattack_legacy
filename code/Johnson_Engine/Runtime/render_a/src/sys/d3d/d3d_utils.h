...
extern char g_szD3DErrorBuffer[256];
#ifdef _DEBUG
#define OUTPUT_D3D_ERROR(iLevel,hResult)	D3DXGetErrorString(hResult,g_szD3DErrorBuffer,256); AddDebugMessage(iLevel,g_szD3DErrorBuffer);
#else

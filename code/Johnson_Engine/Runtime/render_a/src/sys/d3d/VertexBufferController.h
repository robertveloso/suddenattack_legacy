...
public:
	...
	void							SetStreamSources(uint32 iVertOffset = 0);	// Call this before a render call - sets the streams and stuff like that (just need to call it once per group of render calls)...

...
static void d3d_DrawRotatableSprite(const ViewParams& Params, SpriteInstance *pInstance, SharedTexture *pShared)
{
	...
	D3D_CALL(PD3DDEVICE->SetVertexShader(SPRITEVERTEX_FORMAT));
...
void d3d_DrawSprite(const ViewParams& Params, LTObject *pObj)
{
	...
	{
		// [SPIKE]Ãß°¡
		PD3DDEVICE->SetRenderState(D3DRS_ZBIAS, SPRITE_ZBIAS);
		...
		StageStateSet ssWrapModeU0(0, D3DTSS_ADDRESSU, D3DTADDRESS_CLAMP);
		StageStateSet ssWrapModeV0(0, D3DTSS_ADDRESSV, D3DTADDRESS_CLAMP);

...
public:
	...
	void							Render(LTMatrix& WorldTransform, CRenderStyle* pRenderStyle, vector<LPDIRECT3DBASETEXTURE8>& TextureList);

private:
	void							Render_PointSprites(vector<LPDIRECT3DBASETEXTURE8>& TextureList);	// Render using point sprites...
	void							Render_Quads(vector<LPDIRECT3DBASETEXTURE8>& TextureList);			// Render using quads...

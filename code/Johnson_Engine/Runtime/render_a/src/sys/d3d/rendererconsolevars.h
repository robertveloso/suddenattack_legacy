...
RCONVAR(g_CV_MipMapBias, "MipMapBias", int, 0);
...
RCONVAR(g_CV_32BitTextures, "32BitTextures", int, 0);
RCONVAR(g_CV_32BitLightmaps, "32BitLightMaps", int, 0);
...
RCONVAR(g_CV_DynamicLight_Backfacing, "DynamicLight_Backfacing", int, 0);
...
RCONVAR(g_CV_ModelShadow_Proj_LOD, "ModelShadow_Proj_LOD", int, 1);
...
RCONVAR(g_CV_ModelShadow_Proj_BlurShadows, "ModelShadow_Proj_BlurShadows", int, 0);
...
RCONVAR(g_CV_ModelShadow_Proj_EnableBlurPS, "ModelShadow_Proj_EnableBlurPS", int, 0);
...
RCONVAR(g_CV_ModelSaturation, "ModelSaturation", float, 1.5f);
...
// ±¤½Ä : FastCastShadow Test
RCONVAR(g_CV_FastLightObjects, "FastLightObjects", int, 0);

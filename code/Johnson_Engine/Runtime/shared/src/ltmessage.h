...
public:
	...
	virtual void WriteCompPitch(const float fPitch ) { WriteCompPitch(GetPacket(), fPitch); }	// [NOVICE]
	...
	static void WriteCompPitch(CPacket_Write &cPacket, const float fPitch);		// [NOVICE]
...
public:
	...
	virtual float ReadCompPitch() { return ReadCompPitch(GetPacket()); }		// [NOVICE]
	...
	static float ReadCompPitch(CPacket_Read &cPacket);			// [NOVICE]

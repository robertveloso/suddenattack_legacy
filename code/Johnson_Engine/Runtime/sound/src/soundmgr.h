...
public:
	...
	{ m_bBGMEnabled = bEnable; }

	bool		IsEnabled( )
	{ return m_bEnabled; }
	
	bool		IsBGMEnabled() { return m_bBGMEnabled;}
...
public:
	...
	virtual LTRESULT	KillSound( HLTSOUND& hSound, bool bTerm=false )
	;
	...
	virtual void	SetReverbFilter( bool bUse );
...
private:
	...
	bool		m_bValid;
	bool		m_bEnabled;
	bool		m_bBGMEnabled;  //[SPIKE]

	CProvider *	m_p3DProviderList;

	bool		m_bUseReverbFilter;
...
//	===========================================================================
	...
	// NOVICE
	CSoundInstance*		m_DeleteSoundList[SOUNDMGR_MAXSOUNDINSTANCES];
	uint32		m_dwNumDeleteSounds;

...
:	public					CPacket
{
	...
	void					Set( const char * i_strChatMessage )
	{
		...
		strChatMessage[ 41 - 1 ] = '\0';

		this->SetLength( sizeof( NN_Chat ) - ( 41 - 1 - i ) );
	}
...
//struct SN_CurrentRoundResult
//:	public					CPacket
//{
//	enum					{ s_nCode = s_nGameCode + 19 };
//
//	unsigned char			m_byRedWin;
//	unsigned char			m_byBlueWin;
//};
